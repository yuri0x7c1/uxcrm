...
/**
 * Work Effort Content And Info
 */
public class WorkEffortContentAndInfo implements Serializable {

	public static final long serialVersionUID = 9067948789148250112L;
	public static final String NAME = "WorkEffortContentAndInfo";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public WorkEffortContentAndInfo(GenericValue value) {
	...
	public static WorkEffortContentAndInfo fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortContentAndInfo(value);
	}

	public static List<WorkEffortContentAndInfo> fromValues(
			List<GenericValue> values) {
		List<WorkEffortContentAndInfo> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortContentAndInfo(value));
		}
		return entities;
	}
}