...
public class EmplPositionTypeRateBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public EmplPositionTypeRateBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count EmplPositionTypeRates
	 */
	...
	/**
	 * Find EmplPositionTypeRates
	 */
	public List<EmplPositionTypeRate> find(Integer start, Integer number,
	...
	/**
	 * Find one EmplPositionTypeRate
	 */
	public Optional<EmplPositionTypeRate> findOne(Object emplPositionTypeId,
			Object rateTypeId, Object fromDate) {
		List<EmplPositionTypeRate> entityList = null;
		In in = new In();
		in.setEntityName(EmplPositionTypeRate.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("emplPositionTypeId", EntityOperator.EQUALS,
						emplPositionTypeId), new EntityExpr("rateTypeId",
	...
	public Optional<EmplPositionType> getEmplPositionType(
			EmplPositionTypeRate emplPositionTypeRate) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("emplPositionTypeId",
						EntityOperator.EQUALS, emplPositionTypeRate
	 ...
	 * Get salary step
	 */
	public Optional<SalaryStep> getSalaryStep(
			EmplPositionTypeRate emplPositionTypeRate) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("salaryStepSeqId", EntityOperator.EQUALS,
						emplPositionTypeRate.getSalaryStepSeqId()),
				new EntityExpr("payGradeId", EntityOperator.EQUALS,
						emplPositionTypeRate.getPayGradeId()),
				new EntityExpr("fromDate", EntityOperator.EQUALS,
						emplPositionTypeRate.getFromDate())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<RateType> getRateType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("rateTypeId", EntityOperator.EQUALS,
						emplPositionTypeRate.getRateTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
