...
import org.apache.ofbiz.content.content.SubContentDataResourceView;
...
public class SubContentDataResourceViewBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SubContentDataResourceViewBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SubContentDataResourceViews
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(SubContentDataResourceView.NAME);
		if (conditions == null) {
	...
	/**
	 * Find SubContentDataResourceViews
	 */
	public List<SubContentDataResourceView> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SubContentDataResourceView> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SubContentDataResourceView.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = SubContentDataResourceView.fromValues(out
	...
	/**
	 * Find one SubContentDataResourceView
	 */
	public Optional<SubContentDataResourceView> findOne(Object contentId,
			Object drDataResourceId) {
		List<SubContentDataResourceView> entityList = null;
		In in = new In();
		in.setEntityName(SubContentDataResourceView.NAME);
	...
	public Optional<ElectronicText> getElectronicText(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						subContentDataResourceView.getDrDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ContentAssocDataResourceViewFrom> getContentAssocDataResourceViewFroms(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentIdStart", EntityOperator.EQUALS,
						subContentDataResourceView.getContentId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
