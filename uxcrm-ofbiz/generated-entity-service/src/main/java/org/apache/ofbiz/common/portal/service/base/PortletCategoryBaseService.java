...
public class PortletCategoryBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PortletCategoryBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PortletCategories
	 */
	...
	/**
	 * Find PortletCategories
	 */
	public List<PortletCategory> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PortletCategory> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PortletCategory.NAME);
		if (start == null) {
	...
	/**
	 * Find one PortletCategory
	 */
	public Optional<PortletCategory> findOne(Object portletCategoryId) {
	...
	public List<PortletPortletCategory> getPortletPortletCategories(
			PortletCategory portletCategory, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("portletCategoryId",
						EntityOperator.EQUALS, portletCategory
