...
import org.apache.ofbiz.workeffort.workeffort.WorkEffortOrderHeaderView;
...
public class WorkEffortOrderHeaderViewBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortOrderHeaderViewBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortOrderHeaderViews
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(WorkEffortOrderHeaderView.NAME);
		if (conditions == null) {
	...
	/**
	 * Find WorkEffortOrderHeaderViews
	 */
	public List<WorkEffortOrderHeaderView> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<WorkEffortOrderHeaderView> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(WorkEffortOrderHeaderView.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = WorkEffortOrderHeaderView.fromValues(out
	...
	/**
	 * Find one WorkEffortOrderHeaderView
	 */
	public Optional<WorkEffortOrderHeaderView> findOne(Object workEffortId,
			Object orderId) {
		List<WorkEffortOrderHeaderView> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortOrderHeaderView.NAME);
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortOrderHeaderView workEffortOrderHeaderView) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortOrderHeaderView.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderHeader> getOrderHeader(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						workEffortOrderHeaderView.getOrderId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderType> getOrderType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderTypeId", EntityOperator.EQUALS,
						workEffortOrderHeaderView.getOrderTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<StatusItem> getStatusItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						workEffortOrderHeaderView.getStatusId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
