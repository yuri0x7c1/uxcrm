...
public class AudioDataResourceBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AudioDataResourceBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AudioDataResources
	 */
	...
	/**
	 * Find AudioDataResources
	 */
	public List<AudioDataResource> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<AudioDataResource> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(AudioDataResource.NAME);
		if (start == null) {
	...
	/**
	 * Find one AudioDataResource
	 */
	public Optional<AudioDataResource> findOne(Object dataResourceId) {
	...
	public Optional<DataResource> getDataResource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						audioDataResource.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
