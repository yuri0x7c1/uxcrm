...
public class OrderItemContactMechBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderItemContactMechBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderItemContactMeches
	 */
	...
	/**
	 * Find OrderItemContactMeches
	 */
	public List<OrderItemContactMech> find(Integer start, Integer number,
	...
	/**
	 * Find one OrderItemContactMech
	 */
	public Optional<OrderItemContactMech> findOne(Object orderId,
			Object orderItemSeqId, Object contactMechPurposeTypeId) {
		List<OrderItemContactMech> entityList = null;
		In in = new In();
		in.setEntityName(OrderItemContactMech.NAME);
	...
	public Optional<OrderHeader> getOrderHeader(
			OrderItemContactMech orderItemContactMech) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						orderItemContactMech.getOrderId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderItem> getOrderItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("orderId", EntityOperator.EQUALS,
						orderItemContactMech.getOrderId()), new EntityExpr(
						"orderItemSeqId", EntityOperator.EQUALS,
						orderItemContactMech.getOrderItemSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ContactMech> getContactMech(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						orderItemContactMech.getContactMechId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ContactMechPurposeType> getContactMechPurposeType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechPurposeTypeId",
						EntityOperator.EQUALS, orderItemContactMech
