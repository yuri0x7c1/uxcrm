...
public class InvoiceAttributeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public InvoiceAttributeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count InvoiceAttributes
	 */
	...
	/**
	 * Find InvoiceAttributes
	 */
	public List<InvoiceAttribute> find(Integer start, Integer number,
	...
	/**
	 * Find one InvoiceAttribute
	 */
	public Optional<InvoiceAttribute> findOne(Object invoiceId, Object attrName) {
		List<InvoiceAttribute> entityList = null;
		In in = new In();
		in.setEntityName(InvoiceAttribute.NAME);
	 ...
	 * Get invoice
	 */
	public Optional<Invoice> getInvoice(InvoiceAttribute invoiceAttribute) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("invoiceId", EntityOperator.EQUALS,
						invoiceAttribute.getInvoiceId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<InvoiceTypeAttr> getInvoiceTypeAttrs(
			InvoiceAttribute invoiceAttribute, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						invoiceAttribute.getAttrName())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
