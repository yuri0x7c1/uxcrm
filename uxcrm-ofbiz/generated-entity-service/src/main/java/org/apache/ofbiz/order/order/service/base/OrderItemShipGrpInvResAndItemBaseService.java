...
public class OrderItemShipGrpInvResAndItemBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderItemShipGrpInvResAndItemBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderItemShipGrpInvResAndItems
	 */
	...
	/**
	 * Find OrderItemShipGrpInvResAndItems
	 */
	public List<OrderItemShipGrpInvResAndItem> find(Integer start,
	...
	/**
	 * Find one OrderItemShipGrpInvResAndItem
	 */
	public Optional<OrderItemShipGrpInvResAndItem> findOne(
			Object orderItemSeqId, Object orderId, Object shipGroupSeqId,
			Object inventoryItemId) {
		List<OrderItemShipGrpInvResAndItem> entityList = null;
		In in = new In();
		in.setEntityName(OrderItemShipGrpInvResAndItem.NAME);
