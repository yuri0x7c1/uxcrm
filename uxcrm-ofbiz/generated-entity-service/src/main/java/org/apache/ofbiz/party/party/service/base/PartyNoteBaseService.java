...
public class PartyNoteBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyNoteBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find PartyNotes
	 */
	public List<PartyNote> find(Integer start, Integer number,
	 ...
	 * Find one PartyNote
	 */
	public Optional<PartyNote> findOne(Object partyId, Object noteId) {
		List<PartyNote> entityList = null;
		In in = new In();
		in.setEntityName(PartyNote.NAME);
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(PartyNote partyNote) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyNote.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
