...
public class PaymentGatewaySagePayBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewaySagePayBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewaySagePays
	 */
	...
	/**
	 * Find PaymentGatewaySagePays
	 */
	public List<PaymentGatewaySagePay> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewaySagePay> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewaySagePay.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewaySagePay
	 */
	public Optional<PaymentGatewaySagePay> findOne(Object paymentGatewayConfigId) {
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewaySagePay paymentGatewaySagePay) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewaySagePay
