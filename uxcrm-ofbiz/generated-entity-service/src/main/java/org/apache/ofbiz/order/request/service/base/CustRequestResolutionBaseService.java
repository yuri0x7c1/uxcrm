...
public class CustRequestResolutionBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestResolutionBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestResolutions
	 */
	...
	/**
	 * Find CustRequestResolutions
	 */
	public List<CustRequestResolution> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestResolution
	 */
	public Optional<CustRequestResolution> findOne(
			Object custRequestResolutionId) {
		List<CustRequestResolution> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestResolution.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestResolutionId",
						EntityOperator.EQUALS, custRequestResolutionId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<CustRequestItem> getCustRequestItems(
			CustRequestResolution custRequestResolution, Integer start,
