...
public class InventoryItemLabelTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public InventoryItemLabelTypeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count InventoryItemLabelTypes
	 */
	...
	/**
	 * Find InventoryItemLabelTypes
	 */
	public List<InventoryItemLabelType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<InventoryItemLabelType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(InventoryItemLabelType.NAME);
		if (start == null) {
	...
	/**
	 * Find one InventoryItemLabelType
	 */
	public Optional<InventoryItemLabelType> findOne(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("inventoryItemLabelTypeId",
						EntityOperator.EQUALS, inventoryItemLabelTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get parent inventory item label type
	 */
	public Optional<InventoryItemLabelType> getParentInventoryItemLabelType(
			InventoryItemLabelType inventoryItemLabelType) {
		List<InventoryItemLabelType> entityList = null;
		In in = new In();
		in.setEntityName(InventoryItemLabelType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("inventoryItemLabelTypeId",
						EntityOperator.EQUALS, inventoryItemLabelType
	...
	/**
	 * Get inventory item labels
	 */
	public List<InventoryItemLabel> getInventoryItemLabels(
			InventoryItemLabelType inventoryItemLabelType, Integer start,
	...
	/**
	 * Get child inventory item label types
	 */
	public List<InventoryItemLabelType> getChildInventoryItemLabelTypes(
			InventoryItemLabelType inventoryItemLabelType, Integer start,
			Integer number, List<String> orderBy) {
		List<InventoryItemLabelType> entityList = Collections.emptyList();
		In in = new In();
