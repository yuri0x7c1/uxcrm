...
public class OrderItemChangeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderItemChangeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderItemChanges
	 */
	...
	/**
	 * Find OrderItemChanges
	 */
	public List<OrderItemChange> find(Integer start, Integer number,
	...
	/**
	 * Find one OrderItemChange
	 */
	public Optional<OrderItemChange> findOne(Object orderItemChangeId) {
		List<OrderItemChange> entityList = null;
		In in = new In();
		in.setEntityName(OrderItemChange.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderItemChangeId",
						EntityOperator.EQUALS, orderItemChangeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get order header
	 */
	public Optional<OrderHeader> getOrderHeader(OrderItemChange orderItemChange) {
		List<OrderHeader> entityList = null;
		In in = new In();
		in.setEntityName(OrderHeader.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						orderItemChange.getOrderId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<Enumeration> getReasonEnumeration(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("enumId", EntityOperator.EQUALS,
						orderItemChange.getReasonEnumId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Enumeration.fromValues(out.getListIt()
