...
public class PartyContactMechPurposeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyContactMechPurposeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyContactMechPurposes
	 */
	...
	/**
	 * Find PartyContactMechPurposes
	 */
	public List<PartyContactMechPurpose> find(Integer start, Integer number,
	...
	/**
	 * Find one PartyContactMechPurpose
	 */
	public Optional<PartyContactMechPurpose> findOne(Object partyId,
			Object contactMechId, Object contactMechPurposeTypeId,
			Object fromDate) {
		List<PartyContactMechPurpose> entityList = null;
		In in = new In();
		in.setEntityName(PartyContactMechPurpose.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, partyId),
				new EntityExpr("contactMechId", EntityOperator.EQUALS,
						contactMechId), new EntityExpr(
	...
	public List<PartyContactMech> getPartyContactMeches(
			PartyContactMechPurpose partyContactMechPurpose, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS,
						partyContactMechPurpose.getPartyId()), new EntityExpr(
						"contactMechId", EntityOperator.EQUALS,
						partyContactMechPurpose.getContactMechId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ContactMechPurposeType> getContactMechPurposeType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechPurposeTypeId",
						EntityOperator.EQUALS, partyContactMechPurpose
	...
	public Optional<Party> getParty(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyContactMechPurpose.getPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
