...
public class ShipmentContactMechTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ShipmentContactMechTypeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ShipmentContactMechTypes
	 */
	...
	/**
	 * Find ShipmentContactMechTypes
	 */
	public List<ShipmentContactMechType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ShipmentContactMechType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ShipmentContactMechType.NAME);
		if (start == null) {
	...
	/**
	 * Find one ShipmentContactMechType
	 */
	public Optional<ShipmentContactMechType> findOne(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shipmentContactMechTypeId",
						EntityOperator.EQUALS, shipmentContactMechTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ShipmentContactMech> getShipmentContactMeches(
			ShipmentContactMechType shipmentContactMechType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shipmentContactMechTypeId",
						EntityOperator.EQUALS, shipmentContactMechType
