...
public class ImageDataResourceBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ImageDataResourceBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ImageDataResources
	 */
	...
	/**
	 * Find ImageDataResources
	 */
	public List<ImageDataResource> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ImageDataResource> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ImageDataResource.NAME);
		if (start == null) {
	...
	/**
	 * Find one ImageDataResource
	 */
	public Optional<ImageDataResource> findOne(Object dataResourceId) {
	...
	public Optional<DataResource> getDataResource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						imageDataResource.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
