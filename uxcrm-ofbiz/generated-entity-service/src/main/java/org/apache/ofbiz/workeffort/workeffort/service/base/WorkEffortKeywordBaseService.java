...
public class WorkEffortKeywordBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortKeywordBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortKeywords
	 */
	...
	/**
	 * Find WorkEffortKeywords
	 */
	public List<WorkEffortKeyword> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortKeyword
	 */
	public Optional<WorkEffortKeyword> findOne(Object workEffortId,
			Object keyword) {
		List<WorkEffortKeyword> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortKeyword.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortId), new EntityExpr("keyword",
						EntityOperator.EQUALS, keyword)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = WorkEffortKeyword.fromValues(out.getListIt()
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortKeyword workEffortKeyword) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortKeyword.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
