...
public class FinAccountTransTypeAttrBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FinAccountTransTypeAttrBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FinAccountTransTypeAttrs
	 */
	...
	/**
	 * Find FinAccountTransTypeAttrs
	 */
	public List<FinAccountTransTypeAttr> find(Integer start, Integer number,
	...
	/**
	 * Find one FinAccountTransTypeAttr
	 */
	public Optional<FinAccountTransTypeAttr> findOne(
			Object finAccountTransTypeId, Object attrName) {
		List<FinAccountTransTypeAttr> entityList = null;
		In in = new In();
		in.setEntityName(FinAccountTransTypeAttr.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("finAccountTransTypeId", EntityOperator.EQUALS,
						finAccountTransTypeId), new EntityExpr("attrName",
	...
	public Optional<FinAccountTransType> getFinAccountTransType(
			FinAccountTransTypeAttr finAccountTransTypeAttr) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("finAccountTransTypeId",
						EntityOperator.EQUALS, finAccountTransTypeAttr
	...
	public List<FinAccountTransAttribute> getFinAccountTransAttributes(
			FinAccountTransTypeAttr finAccountTransTypeAttr, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						finAccountTransTypeAttr.getAttrName())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
