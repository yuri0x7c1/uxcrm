...
public class OldCustRequestRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OldCustRequestRoleBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OldCustRequestRoles
	 */
	...
	/**
	 * Find OldCustRequestRoles
	 */
	public List<OldCustRequestRole> find(Integer start, Integer number,
	...
	/**
	 * Find one OldCustRequestRole
	 */
	public Optional<OldCustRequestRole> findOne(Object custRequestId,
			Object partyId, Object roleTypeId) {
		List<OldCustRequestRole> entityList = null;
		In in = new In();
		in.setEntityName(OldCustRequestRole.NAME);
	...
	public Optional<CustRequest> getCustRequest(
			OldCustRequestRole oldCustRequestRole) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestId", EntityOperator.EQUALS,
						oldCustRequestRole.getCustRequestId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(OldCustRequestRole oldCustRequestRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						oldCustRequestRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
