...
public class ProdCatalogInvFacilityBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProdCatalogInvFacilityBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProdCatalogInvFacilities
	 */
	...
	/**
	 * Find ProdCatalogInvFacilities
	 */
	public List<ProdCatalogInvFacility> find(Integer start, Integer number,
	...
	/**
	 * Find one ProdCatalogInvFacility
	 */
	public Optional<ProdCatalogInvFacility> findOne(Object prodCatalogId,
			Object facilityId, Object fromDate) {
		List<ProdCatalogInvFacility> entityList = null;
		In in = new In();
		in.setEntityName(ProdCatalogInvFacility.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("prodCatalogId", EntityOperator.EQUALS,
						prodCatalogId), new EntityExpr("facilityId",
	...
	public Optional<ProdCatalog> getProdCatalog(
			ProdCatalogInvFacility prodCatalogInvFacility) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("prodCatalogId", EntityOperator.EQUALS,
						prodCatalogInvFacility.getProdCatalogId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<Facility> getFacility(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						prodCatalogInvFacility.getFacilityId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
