...
import org.apache.ofbiz.accounting.payment.PaymentAndTypePartyNameView;
...
public class PaymentAndTypePartyNameViewBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentAndTypePartyNameViewBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentAndTypePartyNameViews
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(PaymentAndTypePartyNameView.NAME);
		if (conditions == null) {
	...
	/**
	 * Find PaymentAndTypePartyNameViews
	 */
	public List<PaymentAndTypePartyNameView> find(Integer start,
			Integer number, List<String> orderBy, EntityConditionList conditions) {
		List<PaymentAndTypePartyNameView> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentAndTypePartyNameView.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = PaymentAndTypePartyNameView.fromValues(out
	...
	/**
	 * Find one PaymentAndTypePartyNameView
	 */
	public Optional<PaymentAndTypePartyNameView> findOne(Object paymentId) {
		List<PaymentAndTypePartyNameView> entityList = null;
		In in = new In();
		in.setEntityName(PaymentAndTypePartyNameView.NAME);
	...
	public Optional<PaymentType> getPaymentType(
			PaymentAndTypePartyNameView paymentAndTypePartyNameView) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentTypeId", EntityOperator.EQUALS,
						paymentAndTypePartyNameView.getPaymentTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<PaymentMethodType> getPaymentMethodType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentMethodTypeId",
						EntityOperator.EQUALS, paymentAndTypePartyNameView
