...
public class PaymentGatewayEwayBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayEwayBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayEways
	 */
	...
	/**
	 * Find PaymentGatewayEways
	 */
	public List<PaymentGatewayEway> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayEway> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayEway.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayEway
	 */
	public Optional<PaymentGatewayEway> findOne(Object paymentGatewayConfigId) {
