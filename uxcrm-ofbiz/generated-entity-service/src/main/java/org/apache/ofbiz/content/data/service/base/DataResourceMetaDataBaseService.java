...
public class DataResourceMetaDataBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public DataResourceMetaDataBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count DataResourceMetaDatas
	 */
	...
	/**
	 * Find DataResourceMetaDatas
	 */
	public List<DataResourceMetaData> find(Integer start, Integer number,
	...
	/**
	 * Find one DataResourceMetaData
	 */
	public Optional<DataResourceMetaData> findOne(Object dataResourceId,
			Object metaDataPredicateId) {
		List<DataResourceMetaData> entityList = null;
		In in = new In();
		in.setEntityName(DataResourceMetaData.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						dataResourceId), new EntityExpr("metaDataPredicateId",
	...
	public Optional<DataResource> getDataResource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						dataResourceMetaData.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<MetaDataPredicate> getMetaDataPredicate(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("metaDataPredicateId",
						EntityOperator.EQUALS, dataResourceMetaData
	...
	public Optional<DataSource> getDataSource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataSourceId", EntityOperator.EQUALS,
						dataResourceMetaData.getDataSourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
