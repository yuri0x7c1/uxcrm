...
public class ProdCatalogCategoryBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProdCatalogCategoryBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProdCatalogCategories
	 */
	...
	/**
	 * Find ProdCatalogCategories
	 */
	public List<ProdCatalogCategory> find(Integer start, Integer number,
	...
	/**
	 * Find one ProdCatalogCategory
	 */
	public Optional<ProdCatalogCategory> findOne(Object prodCatalogId,
			Object productCategoryId, Object prodCatalogCategoryTypeId,
			Object fromDate) {
		List<ProdCatalogCategory> entityList = null;
		In in = new In();
		in.setEntityName(ProdCatalogCategory.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("prodCatalogId", EntityOperator.EQUALS,
						prodCatalogId), new EntityExpr("productCategoryId",
						EntityOperator.EQUALS, productCategoryId),
				new EntityExpr("prodCatalogCategoryTypeId",
	...
	public Optional<ProdCatalog> getProdCatalog(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("prodCatalogId", EntityOperator.EQUALS,
						prodCatalogCategory.getProdCatalogId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ProductCategory> getProductCategory(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productCategoryId",
						EntityOperator.EQUALS, prodCatalogCategory
	 ...
	 */
	public Optional<ProdCatalogCategoryType> getProdCatalogCategoryType(
			ProdCatalogCategory prodCatalogCategory) {
