...
public class ContentTypeAttrBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ContentTypeAttrBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ContentTypeAttrs
	 */
	...
	/**
	 * Find ContentTypeAttrs
	 */
	public List<ContentTypeAttr> find(Integer start, Integer number,
	...
	/**
	 * Find one ContentTypeAttr
	 */
	public Optional<ContentTypeAttr> findOne(Object contentTypeId,
			Object attrName) {
		List<ContentTypeAttr> entityList = null;
		In in = new In();
		in.setEntityName(ContentTypeAttr.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("contentTypeId", EntityOperator.EQUALS,
						contentTypeId), new EntityExpr("attrName",
	 ...
	 * Get content type
	 */
	public Optional<ContentType> getContentType(ContentTypeAttr contentTypeAttr) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentTypeId", EntityOperator.EQUALS,
						contentTypeAttr.getContentTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ContentAttribute> getContentAttributes(
			ContentTypeAttr contentTypeAttr, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						contentTypeAttr.getAttrName())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get contents
	 */
	public List<Content> getContents(ContentTypeAttr contentTypeAttr,
