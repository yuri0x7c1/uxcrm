...
public class WorkEffortAttributeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortAttributeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortAttributes
	 */
	...
	/**
	 * Find WorkEffortAttributes
	 */
	public List<WorkEffortAttribute> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortAttribute
	 */
	public Optional<WorkEffortAttribute> findOne(Object workEffortId,
			Object attrName) {
		List<WorkEffortAttribute> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortAttribute.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortId), new EntityExpr("attrName",
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortAttribute workEffortAttribute) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortAttribute.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<WorkEffortTypeAttr> getWorkEffortTypeAttrs(
			WorkEffortAttribute workEffortAttribute, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						workEffortAttribute.getAttrName())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
