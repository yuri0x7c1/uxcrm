...
public class FacilityPartyBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FacilityPartyBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FacilityParties
	 */
	...
	/**
	 * Find FacilityParties
	 */
	public List<FacilityParty> find(Integer start, Integer number,
	...
	/**
	 * Find one FacilityParty
	 */
	public Optional<FacilityParty> findOne(Object facilityId, Object partyId,
			Object roleTypeId, Object fromDate) {
		List<FacilityParty> entityList = null;
		In in = new In();
		in.setEntityName(FacilityParty.NAME);
	 ...
	 * Get facility
	 */
	public Optional<Facility> getFacility(FacilityParty facilityParty) {
		List<Facility> entityList = null;
		In in = new In();
		in.setEntityName(Facility.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						facilityParty.getFacilityId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(FacilityParty facilityParty) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						facilityParty.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get party role
	 */
	public Optional<PartyRole> getPartyRole(FacilityParty facilityParty) {
		List<PartyRole> entityList = null;
		In in = new In();
		in.setEntityName(PartyRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, facilityParty
						.getPartyId()), new EntityExpr("roleTypeId",
						EntityOperator.EQUALS, facilityParty.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
