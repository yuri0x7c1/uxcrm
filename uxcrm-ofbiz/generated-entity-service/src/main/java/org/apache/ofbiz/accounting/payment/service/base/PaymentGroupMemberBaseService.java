...
public class PaymentGroupMemberBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGroupMemberBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGroupMembers
	 */
	...
	/**
	 * Find PaymentGroupMembers
	 */
	public List<PaymentGroupMember> find(Integer start, Integer number,
	...
	/**
	 * Find one PaymentGroupMember
	 */
	public Optional<PaymentGroupMember> findOne(Object paymentGroupId,
			Object paymentId, Object fromDate) {
		List<PaymentGroupMember> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGroupMember.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("paymentGroupId", EntityOperator.EQUALS,
						paymentGroupId), new EntityExpr("paymentId",
	 ...
	 * Get payment group
	 */
	public Optional<PaymentGroup> getPaymentGroup(
			PaymentGroupMember paymentGroupMember) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGroupId", EntityOperator.EQUALS,
						paymentGroupMember.getPaymentGroupId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get payment
	 */
	public Optional<Payment> getPayment(PaymentGroupMember paymentGroupMember) {
		List<Payment> entityList = null;
		In in = new In();
		in.setEntityName(Payment.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentId", EntityOperator.EQUALS,
						paymentGroupMember.getPaymentId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
