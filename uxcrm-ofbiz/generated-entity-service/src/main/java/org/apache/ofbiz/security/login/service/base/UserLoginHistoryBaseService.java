...
public class UserLoginHistoryBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public UserLoginHistoryBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count UserLoginHistories
	 */
	...
	/**
	 * Find UserLoginHistories
	 */
	public List<UserLoginHistory> find(Integer start, Integer number,
	...
	/**
	 * Find one UserLoginHistory
	 */
	public Optional<UserLoginHistory> findOne(Object userLoginId,
			Object fromDate) {
		List<UserLoginHistory> entityList = null;
		In in = new In();
		in.setEntityName(UserLoginHistory.NAME);
	 ...
	 * Get user login
	 */
	public Optional<UserLogin> getUserLogin(UserLoginHistory userLoginHistory) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("userLoginId", EntityOperator.EQUALS,
						userLoginHistory.getUserLoginId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(UserLoginHistory userLoginHistory) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						userLoginHistory.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
