...
public class DataResourceAttributeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public DataResourceAttributeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count DataResourceAttributes
	 */
	...
	/**
	 * Find DataResourceAttributes
	 */
	public List<DataResourceAttribute> find(Integer start, Integer number,
	...
	/**
	 * Find one DataResourceAttribute
	 */
	public Optional<DataResourceAttribute> findOne(Object dataResourceId,
			Object attrName) {
		List<DataResourceAttribute> entityList = null;
		In in = new In();
		in.setEntityName(DataResourceAttribute.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						dataResourceId), new EntityExpr("attrName",
	...
	public Optional<DataResource> getDataResource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						dataResourceAttribute.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<DataResourceTypeAttr> getDataResourceTypeAttrs(
			DataResourceAttribute dataResourceAttribute, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						dataResourceAttribute.getAttrName())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
