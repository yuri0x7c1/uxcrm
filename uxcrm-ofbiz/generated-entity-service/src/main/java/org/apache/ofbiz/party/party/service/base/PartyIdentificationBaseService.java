...
public class PartyIdentificationBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyIdentificationBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyIdentifications
	 */
	...
	/**
	 * Find PartyIdentifications
	 */
	public List<PartyIdentification> find(Integer start, Integer number,
	...
	/**
	 * Find one PartyIdentification
	 */
	public Optional<PartyIdentification> findOne(Object partyId,
			Object partyIdentificationTypeId) {
		List<PartyIdentification> entityList = null;
		In in = new In();
		in.setEntityName(PartyIdentification.NAME);
	 ...
	 */
	public Optional<PartyIdentificationType> getPartyIdentificationType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyIdentificationTypeId",
						EntityOperator.EQUALS, partyIdentification
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(PartyIdentification partyIdentification) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyIdentification.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
