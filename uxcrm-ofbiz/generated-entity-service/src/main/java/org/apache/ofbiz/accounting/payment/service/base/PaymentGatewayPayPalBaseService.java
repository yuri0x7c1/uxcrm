...
public class PaymentGatewayPayPalBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayPayPalBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayPayPals
	 */
	...
	/**
	 * Find PaymentGatewayPayPals
	 */
	public List<PaymentGatewayPayPal> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayPayPal> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayPayPal.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayPayPal
	 */
	public Optional<PaymentGatewayPayPal> findOne(Object paymentGatewayConfigId) {
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewayPayPal paymentGatewayPayPal) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewayPayPal
