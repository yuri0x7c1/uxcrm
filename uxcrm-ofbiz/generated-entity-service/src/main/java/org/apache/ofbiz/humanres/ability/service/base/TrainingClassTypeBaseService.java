...
public class TrainingClassTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public TrainingClassTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count TrainingClassTypes
	 */
	...
	/**
	 * Find TrainingClassTypes
	 */
	public List<TrainingClassType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<TrainingClassType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(TrainingClassType.NAME);
		if (start == null) {
	...
	/**
	 * Find one TrainingClassType
	 */
	public Optional<TrainingClassType> findOne(Object trainingClassTypeId) {
		List<TrainingClassType> entityList = null;
		In in = new In();
		in.setEntityName(TrainingClassType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trainingClassTypeId",
						EntityOperator.EQUALS, trainingClassTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get parent training class type
	 */
	public Optional<TrainingClassType> getParentTrainingClassType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trainingClassTypeId",
						EntityOperator.EQUALS, trainingClassType
	...
	public List<PersonTraining> getPersonTrainings(
			TrainingClassType trainingClassType, Integer start, Integer number,
			List<String> orderBy) {
	 ...
	 */
	public List<TrainingClassType> getChildTrainingClassTypes(
			TrainingClassType trainingClassType, Integer start, Integer number,
			List<String> orderBy) {
		List<TrainingClassType> entityList = Collections.emptyList();
		In in = new In();
