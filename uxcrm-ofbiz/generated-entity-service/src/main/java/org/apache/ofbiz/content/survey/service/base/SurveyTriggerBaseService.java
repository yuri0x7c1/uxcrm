...
public class SurveyTriggerBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SurveyTriggerBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SurveyTriggers
	 */
	 ...
	 * Find SurveyTriggers
	 */
	public List<SurveyTrigger> find(Integer start, Integer number,
	...
	/**
	 * Find one SurveyTrigger
	 */
	public Optional<SurveyTrigger> findOne(Object surveyId,
			Object surveyApplTypeId, Object fromDate) {
		List<SurveyTrigger> entityList = null;
		In in = new In();
		in.setEntityName(SurveyTrigger.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("surveyId", EntityOperator.EQUALS, surveyId),
				new EntityExpr("surveyApplTypeId", EntityOperator.EQUALS,
						surveyApplTypeId), new EntityExpr("fromDate",
	...
	public Optional<SurveyApplType> getSurveyApplType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("surveyApplTypeId",
						EntityOperator.EQUALS, surveyTrigger
