...
public class OrderHeaderNoteBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderHeaderNoteBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderHeaderNotes
	 */
	...
	/**
	 * Find OrderHeaderNotes
	 */
	public List<OrderHeaderNote> find(Integer start, Integer number,
	...
	/**
	 * Find one OrderHeaderNote
	 */
	public Optional<OrderHeaderNote> findOne(Object orderId, Object noteId) {
		List<OrderHeaderNote> entityList = null;
		In in = new In();
		in.setEntityName(OrderHeaderNote.NAME);
	 ...
	 * Get order header
	 */
	public Optional<OrderHeader> getOrderHeader(OrderHeaderNote orderHeaderNote) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						orderHeaderNote.getOrderId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get note data
	 */
	public Optional<NoteData> getNoteData(OrderHeaderNote orderHeaderNote) {
		List<NoteData> entityList = null;
		In in = new In();
		in.setEntityName(NoteData.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("noteId", EntityOperator.EQUALS,
						orderHeaderNote.getNoteId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
