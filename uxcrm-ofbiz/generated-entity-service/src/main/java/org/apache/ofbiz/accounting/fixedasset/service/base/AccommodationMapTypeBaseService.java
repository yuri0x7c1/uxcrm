...
public class AccommodationMapTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AccommodationMapTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AccommodationMapTypes
	 */
	...
	/**
	 * Find AccommodationMapTypes
	 */
	public List<AccommodationMapType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<AccommodationMapType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(AccommodationMapType.NAME);
		if (start == null) {
	...
	/**
	 * Find one AccommodationMapType
	 */
	public Optional<AccommodationMapType> findOne(Object accommodationMapTypeId) {
		List<AccommodationMapType> entityList = null;
		In in = new In();
		in.setEntityName(AccommodationMapType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("accommodationMapTypeId",
						EntityOperator.EQUALS, accommodationMapTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<AccommodationMap> getAccommodationMaps(
			AccommodationMapType accommodationMapType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("accommodationMapTypeId",
						EntityOperator.EQUALS, accommodationMapType
