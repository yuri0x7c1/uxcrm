...
public class FixedAssetProductTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FixedAssetProductTypeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FixedAssetProductTypes
	 */
	...
	/**
	 * Find FixedAssetProductTypes
	 */
	public List<FixedAssetProductType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<FixedAssetProductType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(FixedAssetProductType.NAME);
		if (start == null) {
	...
	/**
	 * Find one FixedAssetProductType
	 */
	public Optional<FixedAssetProductType> findOne(
			Object fixedAssetProductTypeId) {
		List<FixedAssetProductType> entityList = null;
		In in = new In();
		in.setEntityName(FixedAssetProductType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("fixedAssetProductTypeId",
						EntityOperator.EQUALS, fixedAssetProductTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<FixedAssetProduct> getFixedAssetProducts(
			FixedAssetProductType fixedAssetProductType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("fixedAssetProductTypeId",
						EntityOperator.EQUALS, fixedAssetProductType
