...
public class CustRequestItemNoteBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestItemNoteBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestItemNotes
	 */
	...
	/**
	 * Find CustRequestItemNotes
	 */
	public List<CustRequestItemNote> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestItemNote
	 */
	public Optional<CustRequestItemNote> findOne(Object custRequestId,
			Object custRequestItemSeqId, Object noteId) {
		List<CustRequestItemNote> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestItemNote.NAME);
	...
	public Optional<NoteData> getNoteData(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("noteId", EntityOperator.EQUALS,
						custRequestItemNote.getNoteId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
