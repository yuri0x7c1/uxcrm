...
public class CustRequestWorkEffortBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestWorkEffortBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestWorkEfforts
	 */
	...
	/**
	 * Find CustRequestWorkEfforts
	 */
	public List<CustRequestWorkEffort> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestWorkEffort
	 */
	public Optional<CustRequestWorkEffort> findOne(Object custRequestId,
			Object workEffortId) {
		List<CustRequestWorkEffort> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestWorkEffort.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("custRequestId", EntityOperator.EQUALS,
						custRequestId), new EntityExpr("workEffortId",
	...
	public Optional<CustRequest> getCustRequest(
			CustRequestWorkEffort custRequestWorkEffort) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestId", EntityOperator.EQUALS,
						custRequestWorkEffort.getCustRequestId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<WorkEffort> getWorkEffort(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						custRequestWorkEffort.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
