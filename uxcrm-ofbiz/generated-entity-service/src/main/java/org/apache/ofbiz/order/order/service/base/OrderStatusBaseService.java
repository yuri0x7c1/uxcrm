...
public class OrderStatusBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderStatusBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find OrderStatuses
	 */
	public List<OrderStatus> find(Integer start, Integer number,
	 ...
	 */
	public Optional<OrderStatus> findOne(Object orderStatusId) {
		List<OrderStatus> entityList = null;
		In in = new In();
		in.setEntityName(OrderStatus.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderStatusId", EntityOperator.EQUALS,
						orderStatusId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = OrderStatus.fromValues(out.getListIt()
	 ...
	 * Get status item
	 */
	public Optional<StatusItem> getStatusItem(OrderStatus orderStatus) {
		List<StatusItem> entityList = null;
		In in = new In();
		in.setEntityName(StatusItem.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						orderStatus.getStatusId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get order item
	 */
	public Optional<OrderItem> getOrderItem(OrderStatus orderStatus) {
	...
	public Optional<OrderPaymentPreference> getOrderPaymentPreference(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderPaymentPreferenceId",
						EntityOperator.EQUALS, orderStatus
