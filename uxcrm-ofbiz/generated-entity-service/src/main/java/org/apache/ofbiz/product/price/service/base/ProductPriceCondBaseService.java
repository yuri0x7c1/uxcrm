...
public class ProductPriceCondBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductPriceCondBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductPriceConds
	 */
	...
	/**
	 * Find ProductPriceConds
	 */
	public List<ProductPriceCond> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductPriceCond
	 */
	public Optional<ProductPriceCond> findOne(Object productPriceRuleId,
			Object productPriceCondSeqId) {
		List<ProductPriceCond> entityList = null;
		In in = new In();
		in.setEntityName(ProductPriceCond.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("productPriceRuleId", EntityOperator.EQUALS,
						productPriceRuleId), new EntityExpr(
						"productPriceCondSeqId", EntityOperator.EQUALS,
						productPriceCondSeqId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = ProductPriceCond.fromValues(out.getListIt()
	...
	public Optional<ProductPriceRule> getProductPriceRule(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productPriceRuleId",
						EntityOperator.EQUALS, productPriceCond
	...
	public Optional<Enumeration> getInputParamEnumeration(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("enumId", EntityOperator.EQUALS,
						productPriceCond.getInputParamEnumId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<Enumeration> getOperatorEnumeration(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("enumId", EntityOperator.EQUALS,
						productPriceCond.getOperatorEnumId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
