...
public class ServerHitTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ServerHitTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ServerHitTypes
	 */
	 ...
	 * Find ServerHitTypes
	 */
	public List<ServerHitType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ServerHitType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ServerHitType.NAME);
		if (start == null) {
	...
	/**
	 * Find one ServerHitType
	 */
	public Optional<ServerHitType> findOne(Object hitTypeId) {
		List<ServerHitType> entityList = null;
		In in = new In();
		in.setEntityName(ServerHitType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("hitTypeId", EntityOperator.EQUALS,
						hitTypeId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = ServerHitType.fromValues(out.getListIt()
	 ...
	 * Get server hits
	 */
	public List<ServerHit> getServerHits(ServerHitType serverHitType,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("hitTypeId", EntityOperator.EQUALS,
						serverHitType.getHitTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get server hit bins
	 */
	public List<ServerHitBin> getServerHitBins(ServerHitType serverHitType,
			Integer start, Integer number, List<String> orderBy) {
