...
public class DocumentTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public DocumentTypeBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find DocumentTypes
	 */
	public List<DocumentType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<DocumentType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(DocumentType.NAME);
		if (start == null) {
	...
	/**
	 * Find one DocumentType
	 */
	public Optional<DocumentType> findOne(Object documentTypeId) {
		List<DocumentType> entityList = null;
		In in = new In();
		in.setEntityName(DocumentType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("documentTypeId", EntityOperator.EQUALS,
						documentTypeId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = DocumentType.fromValues(out.getListIt()
	...
	/**
	 * Get parent document type
	 */
	public Optional<DocumentType> getParentDocumentType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("documentTypeId", EntityOperator.EQUALS,
						documentType.getParentTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = DocumentType.fromValues(out.getListIt()
	...
	public List<Document> getDocuments(DocumentType documentType,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("documentTypeId", EntityOperator.EQUALS,
						documentType.getDocumentTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public List<DocumentType> getChildDocumentTypes(DocumentType documentType,
			Integer start, Integer number, List<String> orderBy) {
		List<DocumentType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(DocumentType.NAME);
	...
	public List<DocumentTypeAttr> getDocumentTypeAttrs(
			DocumentType documentType, Integer start, Integer number,
			List<String> orderBy) {
