...
public class SegmentGroupTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SegmentGroupTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SegmentGroupTypes
	 */
	...
	/**
	 * Find SegmentGroupTypes
	 */
	public List<SegmentGroupType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SegmentGroupType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SegmentGroupType.NAME);
		if (start == null) {
	...
	/**
	 * Find one SegmentGroupType
	 */
	public Optional<SegmentGroupType> findOne(Object segmentGroupTypeId) {
		List<SegmentGroupType> entityList = null;
		In in = new In();
		in.setEntityName(SegmentGroupType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("segmentGroupTypeId",
						EntityOperator.EQUALS, segmentGroupTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<SegmentGroup> getSegmentGroups(
			SegmentGroupType segmentGroupType, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("segmentGroupTypeId",
						EntityOperator.EQUALS, segmentGroupType
