...
public class SalesOpportunityRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SalesOpportunityRoleBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SalesOpportunityRoles
	 */
	...
	/**
	 * Find SalesOpportunityRoles
	 */
	public List<SalesOpportunityRole> find(Integer start, Integer number,
	...
	/**
	 * Find one SalesOpportunityRole
	 */
	public Optional<SalesOpportunityRole> findOne(Object salesOpportunityId,
			Object partyId, Object roleTypeId) {
		List<SalesOpportunityRole> entityList = null;
		In in = new In();
		in.setEntityName(SalesOpportunityRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("salesOpportunityId", EntityOperator.EQUALS,
						salesOpportunityId), new EntityExpr("partyId",
	...
	public Optional<SalesOpportunity> getSalesOpportunity(
			SalesOpportunityRole salesOpportunityRole) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("salesOpportunityId",
						EntityOperator.EQUALS, salesOpportunityRole
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(SalesOpportunityRole salesOpportunityRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						salesOpportunityRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	...
	public Optional<RoleType> getRoleType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("roleTypeId", EntityOperator.EQUALS,
						salesOpportunityRole.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<PartyRole> getPartyRole(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS,
						salesOpportunityRole.getPartyId()), new EntityExpr(
