...
public class CustRequestCategoryBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestCategoryBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestCategories
	 */
	...
	/**
	 * Find CustRequestCategories
	 */
	public List<CustRequestCategory> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestCategory
	 */
	public Optional<CustRequestCategory> findOne(Object custRequestCategoryId) {
		List<CustRequestCategory> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestCategory.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestCategoryId",
						EntityOperator.EQUALS, custRequestCategoryId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<CustRequest> getCustRequests(
			CustRequestCategory custRequestCategory, Integer start,
