...
public class ProductConfigStatsBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductConfigStatsBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductConfigStatses
	 */
	...
	/**
	 * Find ProductConfigStatses
	 */
	public List<ProductConfigStats> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductConfigStats
	 */
	public Optional<ProductConfigStats> findOne(Object configId,
			Object productId) {
		List<ProductConfigStats> entityList = null;
		In in = new In();
		in.setEntityName(ProductConfigStats.NAME);
	...
	public Optional<Product> getProductProduct(
			ProductConfigStats productConfigStats) {
		List<Product> entityList = null;
		In in = new In();
		in.setEntityName(Product.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productId", EntityOperator.EQUALS,
						productConfigStats.getProductId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
