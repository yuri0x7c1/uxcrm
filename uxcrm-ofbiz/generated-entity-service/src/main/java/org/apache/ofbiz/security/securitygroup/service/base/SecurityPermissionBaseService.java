...
public class SecurityPermissionBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SecurityPermissionBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SecurityPermissions
	 */
	...
	/**
	 * Find SecurityPermissions
	 */
	public List<SecurityPermission> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SecurityPermission> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SecurityPermission.NAME);
		if (start == null) {
	...
	/**
	 * Find one SecurityPermission
	 */
	public Optional<SecurityPermission> findOne(Object permissionId) {
	...
	public List<SecurityGroupPermission> getSecurityGroupPermissions(
			SecurityPermission securityPermission, Integer start,
