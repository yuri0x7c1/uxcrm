...
public class WorkEffortCostCalcBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortCostCalcBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortCostCalcs
	 */
	...
	/**
	 * Find WorkEffortCostCalcs
	 */
	public List<WorkEffortCostCalc> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortCostCalc
	 */
	public Optional<WorkEffortCostCalc> findOne(Object workEffortId,
			Object costComponentTypeId, Object fromDate) {
		List<WorkEffortCostCalc> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortCostCalc.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortId), new EntityExpr("costComponentTypeId",
	...
	public Optional<WorkEffort> getWorkEffort(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortCostCalc.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<CostComponentType> getCostComponentType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("costComponentTypeId",
						EntityOperator.EQUALS, workEffortCostCalc
