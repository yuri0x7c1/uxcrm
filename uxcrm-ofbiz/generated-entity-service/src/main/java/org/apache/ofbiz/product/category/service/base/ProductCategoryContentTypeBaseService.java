...
public class ProductCategoryContentTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductCategoryContentTypeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductCategoryContentTypes
	 */
	...
	/**
	 * Find ProductCategoryContentTypes
	 */
	public List<ProductCategoryContentType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ProductCategoryContentType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ProductCategoryContentType.NAME);
		if (start == null) {
	...
	/**
	 * Find one ProductCategoryContentType
	 */
	public Optional<ProductCategoryContentType> findOne(
			Object prodCatContentTypeId) {
		List<ProductCategoryContentType> entityList = null;
		In in = new In();
		in.setEntityName(ProductCategoryContentType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("prodCatContentTypeId",
						EntityOperator.EQUALS, prodCatContentTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get parent product category content type
	 */
	public Optional<ProductCategoryContentType> getParentProductCategoryContentType(
			ProductCategoryContentType productCategoryContentType) {
		List<ProductCategoryContentType> entityList = null;
		In in = new In();
		in.setEntityName(ProductCategoryContentType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("prodCatContentTypeId",
						EntityOperator.EQUALS, productCategoryContentType
	 ...
	 */
	public List<ProductCategoryContentType> getChildProductCategoryContentTypes(
			ProductCategoryContentType productCategoryContentType,
			Integer start, Integer number, List<String> orderBy) {
		List<ProductCategoryContentType> entityList = Collections.emptyList();
		In in = new In();
