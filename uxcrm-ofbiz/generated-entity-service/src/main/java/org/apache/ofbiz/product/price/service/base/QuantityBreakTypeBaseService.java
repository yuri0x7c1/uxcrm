...
public class QuantityBreakTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public QuantityBreakTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count QuantityBreakTypes
	 */
	...
	/**
	 * Find QuantityBreakTypes
	 */
	public List<QuantityBreakType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<QuantityBreakType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(QuantityBreakType.NAME);
		if (start == null) {
	...
	/**
	 * Find one QuantityBreakType
	 */
	public Optional<QuantityBreakType> findOne(Object quantityBreakTypeId) {
		List<QuantityBreakType> entityList = null;
		In in = new In();
		in.setEntityName(QuantityBreakType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("quantityBreakTypeId",
						EntityOperator.EQUALS, quantityBreakTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<QuantityBreak> getQuantityBreaks(
			QuantityBreakType quantityBreakType, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("quantityBreakTypeId",
						EntityOperator.EQUALS, quantityBreakType
