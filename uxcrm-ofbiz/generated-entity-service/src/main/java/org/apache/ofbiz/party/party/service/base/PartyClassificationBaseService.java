...
public class PartyClassificationBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyClassificationBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyClassifications
	 */
	...
	/**
	 * Find PartyClassifications
	 */
	public List<PartyClassification> find(Integer start, Integer number,
	...
	/**
	 * Find one PartyClassification
	 */
	public Optional<PartyClassification> findOne(Object partyId,
			Object partyClassificationGroupId, Object fromDate) {
		List<PartyClassification> entityList = null;
		In in = new In();
		in.setEntityName(PartyClassification.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, partyId),
				new EntityExpr("partyClassificationGroupId",
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(PartyClassification partyClassification) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyClassification.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	...
	public Optional<PartyClassificationGroup> getPartyClassificationGroup(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyClassificationGroupId",
						EntityOperator.EQUALS, partyClassification
