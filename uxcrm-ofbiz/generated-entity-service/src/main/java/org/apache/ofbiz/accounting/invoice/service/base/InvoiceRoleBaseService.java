...
public class InvoiceRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public InvoiceRoleBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find InvoiceRoles
	 */
	public List<InvoiceRole> find(Integer start, Integer number,
	...
	/**
	 * Find one InvoiceRole
	 */
	public Optional<InvoiceRole> findOne(Object invoiceId, Object partyId,
			Object roleTypeId) {
		List<InvoiceRole> entityList = null;
		In in = new In();
		in.setEntityName(InvoiceRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("invoiceId", EntityOperator.EQUALS,
						invoiceId), new EntityExpr("partyId",
	 ...
	 * Get invoice
	 */
	public Optional<Invoice> getInvoice(InvoiceRole invoiceRole) {
		List<Invoice> entityList = null;
		In in = new In();
		in.setEntityName(Invoice.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("invoiceId", EntityOperator.EQUALS,
						invoiceRole.getInvoiceId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(InvoiceRole invoiceRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						invoiceRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get party role
	 */
	public Optional<PartyRole> getPartyRole(InvoiceRole invoiceRole) {
		List<PartyRole> entityList = null;
		In in = new In();
		in.setEntityName(PartyRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, invoiceRole
						.getPartyId()), new EntityExpr("roleTypeId",
						EntityOperator.EQUALS, invoiceRole.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
