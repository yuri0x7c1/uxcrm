...
public class DeliveryBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public DeliveryBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find Deliveries
	 */
	public List<Delivery> find(Integer start, Integer number,
	 ...
	 * Get dest facility
	 */
	public Optional<Facility> getDestFacility(Delivery delivery) {
		List<Facility> entityList = null;
		In in = new In();
		in.setEntityName(Facility.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						delivery.getDestFacilityId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Facility.fromValues(out.getListIt()
	...
	public List<ShipmentRouteSegment> getShipmentRouteSegments(
			Delivery delivery, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("deliveryId", EntityOperator.EQUALS,
						delivery.getDeliveryId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
