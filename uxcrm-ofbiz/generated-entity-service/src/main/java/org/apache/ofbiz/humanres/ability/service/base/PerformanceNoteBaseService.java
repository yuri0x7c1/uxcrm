...
public class PerformanceNoteBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PerformanceNoteBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PerformanceNotes
	 */
	...
	/**
	 * Find PerformanceNotes
	 */
	public List<PerformanceNote> find(Integer start, Integer number,
	...
	/**
	 * Find one PerformanceNote
	 */
	public Optional<PerformanceNote> findOne(Object partyId, Object roleTypeId,
			Object fromDate) {
		List<PerformanceNote> entityList = null;
		In in = new In();
		in.setEntityName(PerformanceNote.NAME);
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(PerformanceNote performanceNote) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						performanceNote.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
