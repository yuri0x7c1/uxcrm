...
public class CustRequestCommEventBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestCommEventBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestCommEvents
	 */
	...
	/**
	 * Find CustRequestCommEvents
	 */
	public List<CustRequestCommEvent> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestCommEvent
	 */
	public Optional<CustRequestCommEvent> findOne(Object custRequestId,
			Object communicationEventId) {
		List<CustRequestCommEvent> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestCommEvent.NAME);
	...
	public Optional<CustRequest> getCustRequest(
			CustRequestCommEvent custRequestCommEvent) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestId", EntityOperator.EQUALS,
						custRequestCommEvent.getCustRequestId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<CommunicationEvent> getCommunicationEvent(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("communicationEventId",
						EntityOperator.EQUALS, custRequestCommEvent
