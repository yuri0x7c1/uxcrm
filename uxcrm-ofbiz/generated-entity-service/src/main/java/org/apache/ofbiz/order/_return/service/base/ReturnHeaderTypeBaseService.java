...
public class ReturnHeaderTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ReturnHeaderTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ReturnHeaderTypes
	 */
	...
	/**
	 * Find ReturnHeaderTypes
	 */
	public List<ReturnHeaderType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ReturnHeaderType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ReturnHeaderType.NAME);
		if (start == null) {
	...
	/**
	 * Find one ReturnHeaderType
	 */
	public Optional<ReturnHeaderType> findOne(Object returnHeaderTypeId) {
	...
	/**
	 * Get parent return header type
	 */
	public Optional<ReturnHeaderType> getParentReturnHeaderType(
			ReturnHeaderType returnHeaderType) {
		List<ReturnHeaderType> entityList = null;
		In in = new In();
		in.setEntityName(ReturnHeaderType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("returnHeaderTypeId",
						EntityOperator.EQUALS, returnHeaderType
	...
	public List<ReturnHeader> getReturnHeaders(
			ReturnHeaderType returnHeaderType, Integer start, Integer number,
			List<String> orderBy) {
	 ...
	 */
	public List<ReturnHeaderType> getChildReturnHeaderTypes(
			ReturnHeaderType returnHeaderType, Integer start, Integer number,
			List<String> orderBy) {
		List<ReturnHeaderType> entityList = Collections.emptyList();
		In in = new In();
