...
public class AgreementContentBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AgreementContentBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AgreementContents
	 */
	...
	/**
	 * Find AgreementContents
	 */
	public List<AgreementContent> find(Integer start, Integer number,
	...
	/**
	 * Find one AgreementContent
	 */
	public Optional<AgreementContent> findOne(Object contentId,
			Object agreementId, Object agreementItemSeqId,
			Object agreementContentTypeId, Object fromDate) {
		List<AgreementContent> entityList = null;
		In in = new In();
		in.setEntityName(AgreementContent.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				...
				new EntityExpr("agreementContentTypeId", EntityOperator.EQUALS,
						agreementContentTypeId), new EntityExpr("fromDate",
	 ...
	 * Get agreement
	 */
	public Optional<Agreement> getAgreement(AgreementContent agreementContent) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("agreementId", EntityOperator.EQUALS,
						agreementContent.getAgreementId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get content
	 */
	public Optional<Content> getContent(AgreementContent agreementContent) {
		List<Content> entityList = null;
		In in = new In();
		in.setEntityName(Content.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentId", EntityOperator.EQUALS,
						agreementContent.getContentId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get agreement content type
	 */
	public Optional<AgreementContentType> getAgreementContentType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("agreementContentTypeId",
						EntityOperator.EQUALS, agreementContent
