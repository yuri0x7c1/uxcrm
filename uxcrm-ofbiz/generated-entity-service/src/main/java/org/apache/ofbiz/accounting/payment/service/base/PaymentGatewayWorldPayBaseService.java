...
public class PaymentGatewayWorldPayBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayWorldPayBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayWorldPays
	 */
	...
	/**
	 * Find PaymentGatewayWorldPays
	 */
	public List<PaymentGatewayWorldPay> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayWorldPay> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayWorldPay.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayWorldPay
	 */
	public Optional<PaymentGatewayWorldPay> findOne(
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewayWorldPay paymentGatewayWorldPay) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewayWorldPay
