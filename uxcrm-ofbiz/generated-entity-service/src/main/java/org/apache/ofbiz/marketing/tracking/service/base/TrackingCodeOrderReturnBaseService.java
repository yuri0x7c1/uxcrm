...
public class TrackingCodeOrderReturnBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public TrackingCodeOrderReturnBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count TrackingCodeOrderReturns
	 */
	...
	/**
	 * Find TrackingCodeOrderReturns
	 */
	public List<TrackingCodeOrderReturn> find(Integer start, Integer number,
	...
	/**
	 * Find one TrackingCodeOrderReturn
	 */
	public Optional<TrackingCodeOrderReturn> findOne(Object returnId,
			Object orderId, Object trackingCodeTypeId) {
		List<TrackingCodeOrderReturn> entityList = null;
		In in = new In();
		in.setEntityName(TrackingCodeOrderReturn.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("returnId", EntityOperator.EQUALS, returnId),
				new EntityExpr("orderId", EntityOperator.EQUALS, orderId),
				new EntityExpr("trackingCodeTypeId", EntityOperator.EQUALS,
						trackingCodeTypeId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = TrackingCodeOrderReturn.fromValues(out.getListIt()
	...
	public Optional<ReturnHeader> getReturnHeader(
			TrackingCodeOrderReturn trackingCodeOrderReturn) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("returnId", EntityOperator.EQUALS,
						trackingCodeOrderReturn.getReturnId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderHeader> getOrderHeader(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						trackingCodeOrderReturn.getOrderId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<TrackingCode> getTrackingCode(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trackingCodeId", EntityOperator.EQUALS,
						trackingCodeOrderReturn.getTrackingCodeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<TrackingCodeType> getTrackingCodeType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trackingCodeTypeId",
						EntityOperator.EQUALS, trackingCodeOrderReturn
