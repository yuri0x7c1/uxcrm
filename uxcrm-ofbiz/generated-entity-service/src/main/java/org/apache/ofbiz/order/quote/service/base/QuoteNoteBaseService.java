...
public class QuoteNoteBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public QuoteNoteBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find QuoteNotes
	 */
	public List<QuoteNote> find(Integer start, Integer number,
	 ...
	 * Find one QuoteNote
	 */
	public Optional<QuoteNote> findOne(Object quoteId, Object noteId) {
		List<QuoteNote> entityList = null;
		In in = new In();
		in.setEntityName(QuoteNote.NAME);
