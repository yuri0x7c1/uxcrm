...
public class SurveyApplTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SurveyApplTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SurveyApplTypes
	 */
	...
	/**
	 * Find SurveyApplTypes
	 */
	public List<SurveyApplType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SurveyApplType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SurveyApplType.NAME);
		if (start == null) {
	...
	/**
	 * Find one SurveyApplType
	 */
	public Optional<SurveyApplType> findOne(Object surveyApplTypeId) {
		List<SurveyApplType> entityList = null;
		In in = new In();
		in.setEntityName(SurveyApplType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("surveyApplTypeId",
						EntityOperator.EQUALS, surveyApplTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ProductStoreSurveyAppl> getProductStoreSurveyAppls(
			SurveyApplType surveyApplType, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("surveyApplTypeId",
						EntityOperator.EQUALS, surveyApplType
	 ...
	 * Get survey triggers
	 */
	public List<SurveyTrigger> getSurveyTriggers(SurveyApplType surveyApplType,
