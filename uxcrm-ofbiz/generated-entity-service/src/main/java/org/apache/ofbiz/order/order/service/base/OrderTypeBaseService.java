...
public class OrderTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderTypeBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find OrderTypes
	 */
	public List<OrderType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<OrderType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(OrderType.NAME);
		if (start == null) {
	 ...
	 */
	public Optional<OrderType> getParentOrderType(OrderType orderType) {
		List<OrderType> entityList = null;
		In in = new In();
		in.setEntityName(OrderType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderTypeId", EntityOperator.EQUALS,
						orderType.getParentTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = OrderType.fromValues(out.getListIt()
	 ...
	 * Get order headers
	 */
	public List<OrderHeader> getOrderHeaders(OrderType orderType,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderTypeId", EntityOperator.EQUALS,
						orderType.getOrderTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public List<OrderType> getChildOrderTypes(OrderType orderType,
			Integer start, Integer number, List<String> orderBy) {
		List<OrderType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(OrderType.NAME);
	 ...
	 */
	public List<OrderTypeAttr> getOrderTypeAttrs(OrderType orderType,
			Integer start, Integer number, List<String> orderBy) {
