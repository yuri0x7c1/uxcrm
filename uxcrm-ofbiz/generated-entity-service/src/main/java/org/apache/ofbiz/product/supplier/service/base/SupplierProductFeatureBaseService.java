...
public class SupplierProductFeatureBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SupplierProductFeatureBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SupplierProductFeatures
	 */
	...
	/**
	 * Find SupplierProductFeatures
	 */
	public List<SupplierProductFeature> find(Integer start, Integer number,
	...
	/**
	 * Find one SupplierProductFeature
	 */
	public Optional<SupplierProductFeature> findOne(Object partyId,
			Object productFeatureId) {
		List<SupplierProductFeature> entityList = null;
		In in = new In();
		in.setEntityName(SupplierProductFeature.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, partyId),
				new EntityExpr("productFeatureId", EntityOperator.EQUALS,
						productFeatureId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = SupplierProductFeature.fromValues(out.getListIt()
	...
	public Optional<Party> getParty(
			SupplierProductFeature supplierProductFeature) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						supplierProductFeature.getPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ProductFeature> getProductFeature(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productFeatureId",
						EntityOperator.EQUALS, supplierProductFeature
	 ...
	 * Get uom
	 */
	public Optional<Uom> getUom(SupplierProductFeature supplierProductFeature) {
		List<Uom> entityList = null;
		In in = new In();
		in.setEntityName(Uom.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("uomId", EntityOperator.EQUALS,
						supplierProductFeature.getUomId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
