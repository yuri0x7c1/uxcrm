...
public class VideoDataResourceBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public VideoDataResourceBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count VideoDataResources
	 */
	...
	/**
	 * Find VideoDataResources
	 */
	public List<VideoDataResource> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<VideoDataResource> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(VideoDataResource.NAME);
		if (start == null) {
	...
	/**
	 * Find one VideoDataResource
	 */
	public Optional<VideoDataResource> findOne(Object dataResourceId) {
	...
	public Optional<DataResource> getDataResource(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						videoDataResource.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
