...
public class ProductFeatureDataResourceBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductFeatureDataResourceBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductFeatureDataResources
	 */
	...
	/**
	 * Find ProductFeatureDataResources
	 */
	public List<ProductFeatureDataResource> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductFeatureDataResource
	 */
	public Optional<ProductFeatureDataResource> findOne(Object dataResourceId,
			Object productFeatureId) {
		List<ProductFeatureDataResource> entityList = null;
		In in = new In();
		in.setEntityName(ProductFeatureDataResource.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						dataResourceId), new EntityExpr("productFeatureId",
	...
	public Optional<DataResource> getDataResource(
			ProductFeatureDataResource productFeatureDataResource) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						productFeatureDataResource.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ProductFeature> getProductFeature(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productFeatureId",
						EntityOperator.EQUALS, productFeatureDataResource
