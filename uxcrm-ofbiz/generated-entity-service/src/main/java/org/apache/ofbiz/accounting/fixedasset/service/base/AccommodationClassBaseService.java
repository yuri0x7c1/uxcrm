...
public class AccommodationClassBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AccommodationClassBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AccommodationClasses
	 */
	...
	/**
	 * Find AccommodationClasses
	 */
	public List<AccommodationClass> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<AccommodationClass> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(AccommodationClass.NAME);
		if (start == null) {
	...
	/**
	 * Find one AccommodationClass
	 */
	public Optional<AccommodationClass> findOne(Object accommodationClassId) {
		List<AccommodationClass> entityList = null;
		In in = new In();
		in.setEntityName(AccommodationClass.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("accommodationClassId",
						EntityOperator.EQUALS, accommodationClassId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get parent accommodation class
	 */
	public Optional<AccommodationClass> getParentAccommodationClass(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("accommodationClassId",
						EntityOperator.EQUALS, accommodationClass
	 ...
	 */
	public List<AccommodationClass> getChildAccommodationClasses(
			AccommodationClass accommodationClass, Integer start,
