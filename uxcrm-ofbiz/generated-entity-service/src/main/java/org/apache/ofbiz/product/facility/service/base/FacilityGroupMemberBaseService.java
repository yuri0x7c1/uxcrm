...
public class FacilityGroupMemberBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FacilityGroupMemberBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FacilityGroupMembers
	 */
	...
	/**
	 * Find FacilityGroupMembers
	 */
	public List<FacilityGroupMember> find(Integer start, Integer number,
	...
	/**
	 * Find one FacilityGroupMember
	 */
	public Optional<FacilityGroupMember> findOne(Object facilityId,
			Object facilityGroupId, Object fromDate) {
		List<FacilityGroupMember> entityList = null;
		In in = new In();
		in.setEntityName(FacilityGroupMember.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						facilityId), new EntityExpr("facilityGroupId",
	...
	public Optional<Facility> getFacility(
			FacilityGroupMember facilityGroupMember) {
		List<Facility> entityList = null;
		In in = new In();
		in.setEntityName(Facility.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						facilityGroupMember.getFacilityId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get facility group
	 */
	public Optional<FacilityGroup> getFacilityGroup(
			FacilityGroupMember facilityGroupMember) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityGroupId",
						EntityOperator.EQUALS, facilityGroupMember
