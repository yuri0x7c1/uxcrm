...
public class DeliverableBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public DeliverableBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find Deliverables
	 */
	public List<Deliverable> find(Integer start, Integer number,
	...
	/**
	 * Find one Deliverable
	 */
	public Optional<Deliverable> findOne(Object deliverableId) {
		List<Deliverable> entityList = null;
		In in = new In();
		in.setEntityName(Deliverable.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("deliverableId", EntityOperator.EQUALS,
						deliverableId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Deliverable.fromValues(out.getListIt()
	 ...
	 * Get requirements
	 */
	public List<Requirement> getRequirements(Deliverable deliverable,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("deliverableId", EntityOperator.EQUALS,
						deliverable.getDeliverableId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<WorkEffortDeliverableProd> getWorkEffortDeliverableProds(
			Deliverable deliverable, Integer start, Integer number,
			List<String> orderBy) {
