...
public class ProductPromoCodePartyBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductPromoCodePartyBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductPromoCodeParties
	 */
	...
	/**
	 * Find ProductPromoCodeParties
	 */
	public List<ProductPromoCodeParty> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductPromoCodeParty
	 */
	public Optional<ProductPromoCodeParty> findOne(Object productPromoCodeId,
			Object partyId) {
		List<ProductPromoCodeParty> entityList = null;
		In in = new In();
		in.setEntityName(ProductPromoCodeParty.NAME);
	...
	public Optional<ProductPromoCode> getProductPromoCode(
			ProductPromoCodeParty productPromoCodeParty) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productPromoCodeId",
						EntityOperator.EQUALS, productPromoCodeParty
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(ProductPromoCodeParty productPromoCodeParty) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						productPromoCodeParty.getPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
