...
public class SupplierRatingTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SupplierRatingTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SupplierRatingTypes
	 */
	...
	/**
	 * Find SupplierRatingTypes
	 */
	public List<SupplierRatingType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SupplierRatingType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SupplierRatingType.NAME);
		if (start == null) {
	...
	/**
	 * Find one SupplierRatingType
	 */
	public Optional<SupplierRatingType> findOne(Object supplierRatingTypeId) {
		List<SupplierRatingType> entityList = null;
		In in = new In();
		in.setEntityName(SupplierRatingType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("supplierRatingTypeId",
						EntityOperator.EQUALS, supplierRatingTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<SupplierProduct> getSupplierProducts(
			SupplierRatingType supplierRatingType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("supplierRatingTypeId",
						EntityOperator.EQUALS, supplierRatingType
