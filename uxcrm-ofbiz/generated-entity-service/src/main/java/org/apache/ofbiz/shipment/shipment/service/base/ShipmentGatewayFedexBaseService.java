...
public class ShipmentGatewayFedexBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ShipmentGatewayFedexBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ShipmentGatewayFedexes
	 */
	...
	/**
	 * Find ShipmentGatewayFedexes
	 */
	public List<ShipmentGatewayFedex> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ShipmentGatewayFedex> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ShipmentGatewayFedex.NAME);
		if (start == null) {
	...
	/**
	 * Find one ShipmentGatewayFedex
	 */
	public Optional<ShipmentGatewayFedex> findOne(Object shipmentGatewayConfigId) {
