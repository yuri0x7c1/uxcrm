...
public class ShoppingListTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ShoppingListTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ShoppingListTypes
	 */
	...
	/**
	 * Find ShoppingListTypes
	 */
	public List<ShoppingListType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ShoppingListType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ShoppingListType.NAME);
		if (start == null) {
	...
	/**
	 * Find one ShoppingListType
	 */
	public Optional<ShoppingListType> findOne(Object shoppingListTypeId) {
		List<ShoppingListType> entityList = null;
		In in = new In();
		in.setEntityName(ShoppingListType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shoppingListTypeId",
						EntityOperator.EQUALS, shoppingListTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ShoppingList> getShoppingLists(
			ShoppingListType shoppingListType, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shoppingListTypeId",
						EntityOperator.EQUALS, shoppingListType
