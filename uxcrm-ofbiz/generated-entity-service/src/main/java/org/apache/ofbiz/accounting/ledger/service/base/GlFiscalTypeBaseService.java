...
public class GlFiscalTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public GlFiscalTypeBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find GlFiscalTypes
	 */
	public List<GlFiscalType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<GlFiscalType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(GlFiscalType.NAME);
		if (start == null) {
	...
	/**
	 * Find one GlFiscalType
	 */
	public Optional<GlFiscalType> findOne(Object glFiscalTypeId) {
		List<GlFiscalType> entityList = null;
		In in = new In();
		in.setEntityName(GlFiscalType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glFiscalTypeId", EntityOperator.EQUALS,
						glFiscalTypeId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = GlFiscalType.fromValues(out.getListIt()
	 ...
	 * Get acctg transes
	 */
	public List<AcctgTrans> getAcctgTranses(GlFiscalType glFiscalType,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glFiscalTypeId", EntityOperator.EQUALS,
						glFiscalType.getGlFiscalTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
