...
import org.apache.ofbiz.workeffort.workeffort.WorkEffortCommunicationEventView;
...
public class WorkEffortCommunicationEventViewBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortCommunicationEventViewBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortCommunicationEventViews
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(WorkEffortCommunicationEventView.NAME);
		if (conditions == null) {
	...
	/**
	 * Find WorkEffortCommunicationEventViews
	 */
	public List<WorkEffortCommunicationEventView> find(Integer start,
			Integer number, List<String> orderBy, EntityConditionList conditions) {
		List<WorkEffortCommunicationEventView> entityList = Collections
				.emptyList();
		In in = new In();
		in.setEntityName(WorkEffortCommunicationEventView.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = WorkEffortCommunicationEventView.fromValues(out
	...
	/**
	 * Find one WorkEffortCommunicationEventView
	 */
	public Optional<WorkEffortCommunicationEventView> findOne(
			Object workEffortId, Object communicationEventId) {
		List<WorkEffortCommunicationEventView> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortCommunicationEventView.NAME);
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortCommunicationEventView workEffortCommunicationEventView) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortCommunicationEventView.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<CommunicationEvent> getCommunicationEvent(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("communicationEventId",
						EntityOperator.EQUALS, workEffortCommunicationEventView
