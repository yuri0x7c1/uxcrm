...
public class OldAgreementWorkEffortApplBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OldAgreementWorkEffortApplBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OldAgreementWorkEffortAppls
	 */
	...
	/**
	 * Find OldAgreementWorkEffortAppls
	 */
	public List<OldAgreementWorkEffortAppl> find(Integer start, Integer number,
	...
	/**
	 * Find one OldAgreementWorkEffortAppl
	 */
	public Optional<OldAgreementWorkEffortAppl> findOne(Object agreementId,
			Object agreementItemSeqId, Object workEffortId) {
		List<OldAgreementWorkEffortAppl> entityList = null;
		In in = new In();
		in.setEntityName(OldAgreementWorkEffortAppl.NAME);
	...
	public Optional<Agreement> getAgreement(
			OldAgreementWorkEffortAppl oldAgreementWorkEffortAppl) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("agreementId", EntityOperator.EQUALS,
						oldAgreementWorkEffortAppl.getAgreementId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<AgreementItem> getAgreementItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				...
				new EntityExpr("agreementItemSeqId", EntityOperator.EQUALS,
						oldAgreementWorkEffortAppl.getAgreementItemSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<WorkEffort> getWorkEffort(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						oldAgreementWorkEffortAppl.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
