...
public class MimeTypeHtmlTemplateBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public MimeTypeHtmlTemplateBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count MimeTypeHtmlTemplates
	 */
	...
	/**
	 * Find MimeTypeHtmlTemplates
	 */
	public List<MimeTypeHtmlTemplate> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<MimeTypeHtmlTemplate> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(MimeTypeHtmlTemplate.NAME);
		if (start == null) {
	...
	/**
	 * Find one MimeTypeHtmlTemplate
	 */
	public Optional<MimeTypeHtmlTemplate> findOne(Object mimeTypeId) {
	...
	public Optional<MimeType> getMimeType(
			MimeTypeHtmlTemplate mimeTypeHtmlTemplate) {
		List<MimeType> entityList = null;
		In in = new In();
		in.setEntityName(MimeType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("mimeTypeId", EntityOperator.EQUALS,
						mimeTypeHtmlTemplate.getMimeTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
