...
public class ProductCategoryLinkBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductCategoryLinkBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductCategoryLinks
	 */
	...
	/**
	 * Find ProductCategoryLinks
	 */
	public List<ProductCategoryLink> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductCategoryLink
	 */
	public Optional<ProductCategoryLink> findOne(Object productCategoryId,
			Object linkSeqId, Object fromDate) {
		List<ProductCategoryLink> entityList = null;
		In in = new In();
		in.setEntityName(ProductCategoryLink.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("productCategoryId", EntityOperator.EQUALS,
						productCategoryId), new EntityExpr("linkSeqId",
						EntityOperator.EQUALS, linkSeqId), new EntityExpr(
	...
	public Optional<ProductCategory> getProductCategory(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productCategoryId",
						EntityOperator.EQUALS, productCategoryLink
	...
	/**
	 * Get link type enumeration
	 */
	public Optional<Enumeration> getLinkTypeEnumeration(
			ProductCategoryLink productCategoryLink) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("enumId", EntityOperator.EQUALS,
						productCategoryLink.getLinkTypeEnumId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
