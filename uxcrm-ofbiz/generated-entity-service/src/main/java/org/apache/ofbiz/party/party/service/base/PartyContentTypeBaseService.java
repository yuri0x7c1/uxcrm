...
public class PartyContentTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyContentTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyContentTypes
	 */
	...
	/**
	 * Find PartyContentTypes
	 */
	public List<PartyContentType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PartyContentType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PartyContentType.NAME);
		if (start == null) {
	...
	/**
	 * Find one PartyContentType
	 */
	public Optional<PartyContentType> findOne(Object partyContentTypeId) {
		List<PartyContentType> entityList = null;
		In in = new In();
		in.setEntityName(PartyContentType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyContentTypeId",
						EntityOperator.EQUALS, partyContentTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get parent party content type
	 */
	public Optional<PartyContentType> getParentPartyContentType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyContentTypeId",
						EntityOperator.EQUALS, partyContentType
	...
	public List<PartyContent> getPartyContents(
			PartyContentType partyContentType, Integer start, Integer number,
			List<String> orderBy) {
	 ...
	 */
	public List<PartyContentType> getChildPartyContentTypes(
			PartyContentType partyContentType, Integer start, Integer number,
			List<String> orderBy) {
		List<PartyContentType> entityList = Collections.emptyList();
		In in = new In();
