...
public class FixedAssetGeoPointBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FixedAssetGeoPointBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FixedAssetGeoPoints
	 */
	...
	/**
	 * Find FixedAssetGeoPoints
	 */
	public List<FixedAssetGeoPoint> find(Integer start, Integer number,
	...
	/**
	 * Find one FixedAssetGeoPoint
	 */
	public Optional<FixedAssetGeoPoint> findOne(Object fixedAssetId,
			Object geoPointId, Object fromDate) {
		List<FixedAssetGeoPoint> entityList = null;
		In in = new In();
		in.setEntityName(FixedAssetGeoPoint.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("fixedAssetId", EntityOperator.EQUALS,
						fixedAssetId), new EntityExpr("geoPointId",
	...
	public Optional<FixedAsset> getFixedAsset(
			FixedAssetGeoPoint fixedAssetGeoPoint) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("fixedAssetId", EntityOperator.EQUALS,
						fixedAssetGeoPoint.getFixedAssetId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
