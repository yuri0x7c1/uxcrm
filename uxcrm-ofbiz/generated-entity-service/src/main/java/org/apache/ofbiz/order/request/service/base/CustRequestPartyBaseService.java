...
public class CustRequestPartyBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CustRequestPartyBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CustRequestParties
	 */
	...
	/**
	 * Find CustRequestParties
	 */
	public List<CustRequestParty> find(Integer start, Integer number,
	...
	/**
	 * Find one CustRequestParty
	 */
	public Optional<CustRequestParty> findOne(Object custRequestId,
			Object partyId, Object roleTypeId, Object fromDate) {
		List<CustRequestParty> entityList = null;
		In in = new In();
		in.setEntityName(CustRequestParty.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("custRequestId", EntityOperator.EQUALS,
						custRequestId), new EntityExpr("partyId",
	...
	public Optional<CustRequest> getCustRequest(
			CustRequestParty custRequestParty) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("custRequestId", EntityOperator.EQUALS,
						custRequestParty.getCustRequestId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(CustRequestParty custRequestParty) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						custRequestParty.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get role type
	 */
	public Optional<RoleType> getRoleType(CustRequestParty custRequestParty) {
		List<RoleType> entityList = null;
		In in = new In();
		in.setEntityName(RoleType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("roleTypeId", EntityOperator.EQUALS,
						custRequestParty.getRoleTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
