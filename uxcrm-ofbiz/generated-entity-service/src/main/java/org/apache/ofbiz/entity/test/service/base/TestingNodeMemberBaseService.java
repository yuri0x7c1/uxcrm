...
public class TestingNodeMemberBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public TestingNodeMemberBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count TestingNodeMembers
	 */
	...
	/**
	 * Find TestingNodeMembers
	 */
	public List<TestingNodeMember> find(Integer start, Integer number,
	...
	/**
	 * Find one TestingNodeMember
	 */
	public Optional<TestingNodeMember> findOne(Object testingNodeId,
			Object testingId, Object fromDate) {
		List<TestingNodeMember> entityList = null;
		In in = new In();
		in.setEntityName(TestingNodeMember.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("testingNodeId", EntityOperator.EQUALS,
						testingNodeId), new EntityExpr("testingId",
						EntityOperator.EQUALS, testingId), new EntityExpr(
	 ...
	 * Get testing
	 */
	public Optional<Testing> getTesting(TestingNodeMember testingNodeMember) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("testingId", EntityOperator.EQUALS,
						testingNodeMember.getTestingId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<TestingNode> getTestingNode(
			TestingNodeMember testingNodeMember) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("testingNodeId", EntityOperator.EQUALS,
						testingNodeMember.getTestingNodeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
