...
public class InvoiceItemTypeAttrBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public InvoiceItemTypeAttrBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count InvoiceItemTypeAttrs
	 */
	...
	/**
	 * Find InvoiceItemTypeAttrs
	 */
	public List<InvoiceItemTypeAttr> find(Integer start, Integer number,
	...
	/**
	 * Find one InvoiceItemTypeAttr
	 */
	public Optional<InvoiceItemTypeAttr> findOne(Object invoiceItemTypeId,
			Object attrName) {
		List<InvoiceItemTypeAttr> entityList = null;
		In in = new In();
		in.setEntityName(InvoiceItemTypeAttr.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("invoiceItemTypeId", EntityOperator.EQUALS,
						invoiceItemTypeId), new EntityExpr("attrName",
	...
	public Optional<InvoiceItemType> getInvoiceItemType(
			InvoiceItemTypeAttr invoiceItemTypeAttr) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("invoiceItemTypeId",
						EntityOperator.EQUALS, invoiceItemTypeAttr
	...
	public List<InvoiceItemAttribute> getInvoiceItemAttributes(
			InvoiceItemTypeAttr invoiceItemTypeAttr, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						invoiceItemTypeAttr.getAttrName())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
