...
public class ShipmentGatewayDhlBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ShipmentGatewayDhlBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ShipmentGatewayDhls
	 */
	...
	/**
	 * Find ShipmentGatewayDhls
	 */
	public List<ShipmentGatewayDhl> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ShipmentGatewayDhl> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ShipmentGatewayDhl.NAME);
		if (start == null) {
	...
	/**
	 * Find one ShipmentGatewayDhl
	 */
	public Optional<ShipmentGatewayDhl> findOne(Object shipmentGatewayConfigId) {
