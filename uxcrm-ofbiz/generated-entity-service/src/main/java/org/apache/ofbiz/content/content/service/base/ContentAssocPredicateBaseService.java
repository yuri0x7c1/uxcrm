...
public class ContentAssocPredicateBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ContentAssocPredicateBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ContentAssocPredicates
	 */
	...
	/**
	 * Find ContentAssocPredicates
	 */
	public List<ContentAssocPredicate> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ContentAssocPredicate> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ContentAssocPredicate.NAME);
		if (start == null) {
	...
	/**
	 * Find one ContentAssocPredicate
	 */
	public Optional<ContentAssocPredicate> findOne(
			Object contentAssocPredicateId) {
		List<ContentAssocPredicate> entityList = null;
		In in = new In();
		in.setEntityName(ContentAssocPredicate.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentAssocPredicateId",
						EntityOperator.EQUALS, contentAssocPredicateId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<ContentAssoc> getContentAssocs(
			ContentAssocPredicate contentAssocPredicate, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentAssocPredicateId",
						EntityOperator.EQUALS, contentAssocPredicate
