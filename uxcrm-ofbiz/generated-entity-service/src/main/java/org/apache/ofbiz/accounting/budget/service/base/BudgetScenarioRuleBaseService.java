...
public class BudgetScenarioRuleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public BudgetScenarioRuleBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count BudgetScenarioRules
	 */
	...
	/**
	 * Find BudgetScenarioRules
	 */
	public List<BudgetScenarioRule> find(Integer start, Integer number,
	...
	/**
	 * Find one BudgetScenarioRule
	 */
	public Optional<BudgetScenarioRule> findOne(Object budgetScenarioId,
			Object budgetItemTypeId) {
		List<BudgetScenarioRule> entityList = null;
		In in = new In();
		in.setEntityName(BudgetScenarioRule.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("budgetScenarioId", EntityOperator.EQUALS,
						budgetScenarioId), new EntityExpr("budgetItemTypeId",
