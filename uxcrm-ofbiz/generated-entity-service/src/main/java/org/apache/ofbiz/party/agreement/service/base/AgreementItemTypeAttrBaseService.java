...
public class AgreementItemTypeAttrBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AgreementItemTypeAttrBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AgreementItemTypeAttrs
	 */
	...
	/**
	 * Find AgreementItemTypeAttrs
	 */
	public List<AgreementItemTypeAttr> find(Integer start, Integer number,
	...
	/**
	 * Find one AgreementItemTypeAttr
	 */
	public Optional<AgreementItemTypeAttr> findOne(Object agreementItemTypeId,
			Object attrName) {
		List<AgreementItemTypeAttr> entityList = null;
		In in = new In();
		in.setEntityName(AgreementItemTypeAttr.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("agreementItemTypeId", EntityOperator.EQUALS,
						agreementItemTypeId), new EntityExpr("attrName",
	...
	public Optional<AgreementItemType> getAgreementItemType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("agreementItemTypeId",
						EntityOperator.EQUALS, agreementItemTypeAttr
	...
	public List<AgreementItemAttribute> getAgreementItemAttributes(
			AgreementItemTypeAttr agreementItemTypeAttr, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						agreementItemTypeAttr.getAttrName())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
