...
public class WorkEffortSearchResultBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortSearchResultBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortSearchResults
	 */
	...
	/**
	 * Find WorkEffortSearchResults
	 */
	public List<WorkEffortSearchResult> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<WorkEffortSearchResult> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(WorkEffortSearchResult.NAME);
		if (start == null) {
	...
	/**
	 * Find one WorkEffortSearchResult
	 */
	public Optional<WorkEffortSearchResult> findOne(
			Object workEffortSearchResultId) {
	...
	/**
	 * Get work effort search constraints
	 */
	public List<WorkEffortSearchConstraint> getWorkEffortSearchConstraints(
			WorkEffortSearchResult workEffortSearchResult, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortSearchResultId",
						EntityOperator.EQUALS, workEffortSearchResult
