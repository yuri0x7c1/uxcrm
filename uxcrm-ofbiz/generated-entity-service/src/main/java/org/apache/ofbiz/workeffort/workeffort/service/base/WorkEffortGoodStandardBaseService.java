...
public class WorkEffortGoodStandardBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortGoodStandardBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortGoodStandards
	 */
	...
	/**
	 * Find WorkEffortGoodStandards
	 */
	public List<WorkEffortGoodStandard> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortGoodStandard
	 */
	public Optional<WorkEffortGoodStandard> findOne(Object workEffortId,
			Object productId, Object workEffortGoodStdTypeId, Object fromDate) {
		List<WorkEffortGoodStandard> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortGoodStandard.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortId), new EntityExpr("productId",
	...
	public Optional<WorkEffort> getWorkEffort(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortGoodStandard.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get work effort good standard type
	 */
	public Optional<WorkEffortGoodStandardType> getWorkEffortGoodStandardType(
			WorkEffortGoodStandard workEffortGoodStandard) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortGoodStdTypeId",
						EntityOperator.EQUALS, workEffortGoodStandard
	...
	public Optional<Product> getProduct(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productId", EntityOperator.EQUALS,
						workEffortGoodStandard.getProductId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<StatusItem> getStatusItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						workEffortGoodStandard.getStatusId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
