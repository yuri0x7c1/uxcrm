...
import org.apache.ofbiz.workeffort.workeffort.WorkEffortAndPartyAssign;
...
public class WorkEffortAndPartyAssignBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortAndPartyAssignBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortAndPartyAssigns
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(WorkEffortAndPartyAssign.NAME);
		if (conditions == null) {
	...
	/**
	 * Find WorkEffortAndPartyAssigns
	 */
	public List<WorkEffortAndPartyAssign> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<WorkEffortAndPartyAssign> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(WorkEffortAndPartyAssign.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = WorkEffortAndPartyAssign.fromValues(out
	...
	/**
	 * Find one WorkEffortAndPartyAssign
	 */
	public Optional<WorkEffortAndPartyAssign> findOne(Object workEffortId,
			Object roleTypeId, Object fromDate, Object partyId) {
		List<WorkEffortAndPartyAssign> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortAndPartyAssign.NAME);
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortAndPartyAssign workEffortAndPartyAssign) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortAndPartyAssign.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<WorkEffortPartyAssignment> getWorkEffortPartyAssignment(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				...
				new EntityExpr("partyId", EntityOperator.EQUALS,
						workEffortAndPartyAssign.getPartyId()), new EntityExpr(
						"roleTypeId", EntityOperator.EQUALS,
						workEffortAndPartyAssign.getRoleTypeId()),
				new EntityExpr("fromDate", EntityOperator.EQUALS,
						workEffortAndPartyAssign.getFromDate())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<WorkEffortType> getWorkEffortType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortTypeId",
						EntityOperator.EQUALS, workEffortAndPartyAssign
	...
	public Optional<Party> getParty(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						workEffortAndPartyAssign.getPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
