...
public class SurveyResponseAnswerBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SurveyResponseAnswerBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SurveyResponseAnswers
	 */
	...
	/**
	 * Find SurveyResponseAnswers
	 */
	public List<SurveyResponseAnswer> find(Integer start, Integer number,
	...
	/**
	 * Find one SurveyResponseAnswer
	 */
	public Optional<SurveyResponseAnswer> findOne(Object surveyResponseId,
			Object surveyQuestionId, Object surveyMultiRespColId) {
		List<SurveyResponseAnswer> entityList = null;
		In in = new In();
		in.setEntityName(SurveyResponseAnswer.NAME);
	...
	public Optional<SurveyResponse> getSurveyResponse(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("surveyResponseId",
						EntityOperator.EQUALS, surveyResponseAnswer
	...
	public Optional<SurveyQuestionOption> getSurveyQuestionOption(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("surveyQuestionId", EntityOperator.EQUALS,
						surveyResponseAnswer.getSurveyQuestionId()),
				new EntityExpr("surveyOptionSeqId", EntityOperator.EQUALS,
						surveyResponseAnswer.getSurveyOptionSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<Content> getContent(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentId", EntityOperator.EQUALS,
						surveyResponseAnswer.getContentId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
