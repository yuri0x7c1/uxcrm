...
public class InvoiceItemTypeGlAccountBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public InvoiceItemTypeGlAccountBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count InvoiceItemTypeGlAccounts
	 */
	...
	/**
	 * Find InvoiceItemTypeGlAccounts
	 */
	public List<InvoiceItemTypeGlAccount> find(Integer start, Integer number,
	...
	/**
	 * Find one InvoiceItemTypeGlAccount
	 */
	public Optional<InvoiceItemTypeGlAccount> findOne(Object invoiceItemTypeId,
			Object organizationPartyId) {
		List<InvoiceItemTypeGlAccount> entityList = null;
		In in = new In();
		in.setEntityName(InvoiceItemTypeGlAccount.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("invoiceItemTypeId", EntityOperator.EQUALS,
						invoiceItemTypeId), new EntityExpr(
	...
	public Optional<InvoiceItemType> getInvoiceItemType(
			InvoiceItemTypeGlAccount invoiceItemTypeGlAccount) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("invoiceItemTypeId",
						EntityOperator.EQUALS, invoiceItemTypeGlAccount
	...
	public Optional<Party> getOrganizationParty(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						invoiceItemTypeGlAccount.getOrganizationPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<GlAccount> getGlAccount(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glAccountId", EntityOperator.EQUALS,
						invoiceItemTypeGlAccount.getGlAccountId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
