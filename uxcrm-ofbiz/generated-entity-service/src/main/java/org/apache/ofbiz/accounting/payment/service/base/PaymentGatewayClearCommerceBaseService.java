...
public class PaymentGatewayClearCommerceBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayClearCommerceBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayClearCommerces
	 */
	...
	/**
	 * Find PaymentGatewayClearCommerces
	 */
	public List<PaymentGatewayClearCommerce> find(Integer start,
			Integer number, List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayClearCommerce> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayClearCommerce.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayClearCommerce
	 */
	public Optional<PaymentGatewayClearCommerce> findOne(
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewayClearCommerce paymentGatewayClearCommerce) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewayClearCommerce
