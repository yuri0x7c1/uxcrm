...
public class WebPageBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WebPageBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find WebPages
	 */
	public List<WebPage> find(Integer start, Integer number,
	 ...
	 * Find one WebPage
	 */
	public Optional<WebPage> findOne(Object webPageId) {
		List<WebPage> entityList = null;
		In in = new In();
		in.setEntityName(WebPage.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("webPageId", EntityOperator.EQUALS,
						webPageId)), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = WebPage.fromValues(out.getListIt()
						.getCompleteList());
				out.getListIt().close();
			}
		} catch (GenericEntityException e) {
