...
public class OrderBlacklistTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderBlacklistTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderBlacklistTypes
	 */
	...
	/**
	 * Find OrderBlacklistTypes
	 */
	public List<OrderBlacklistType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<OrderBlacklistType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(OrderBlacklistType.NAME);
		if (start == null) {
	...
	/**
	 * Find one OrderBlacklistType
	 */
	public Optional<OrderBlacklistType> findOne(Object orderBlacklistTypeId) {
		List<OrderBlacklistType> entityList = null;
		In in = new In();
		in.setEntityName(OrderBlacklistType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderBlacklistTypeId",
						EntityOperator.EQUALS, orderBlacklistTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<OrderBlacklist> getOrderBlacklists(
			OrderBlacklistType orderBlacklistType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderBlacklistTypeId",
						EntityOperator.EQUALS, orderBlacklistType
