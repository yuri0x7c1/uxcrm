...
public class CommContentAssocTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public CommContentAssocTypeBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count CommContentAssocTypes
	 */
	...
	/**
	 * Find CommContentAssocTypes
	 */
	public List<CommContentAssocType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<CommContentAssocType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(CommContentAssocType.NAME);
		if (start == null) {
	...
	/**
	 * Find one CommContentAssocType
	 */
	public Optional<CommContentAssocType> findOne(Object commContentAssocTypeId) {
		List<CommContentAssocType> entityList = null;
		In in = new In();
		in.setEntityName(CommContentAssocType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("commContentAssocTypeId",
						EntityOperator.EQUALS, commContentAssocTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<CommEventContentAssoc> getCommEventContentAssocs(
			CommContentAssocType commContentAssocType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("commContentAssocTypeId",
						EntityOperator.EQUALS, commContentAssocType
