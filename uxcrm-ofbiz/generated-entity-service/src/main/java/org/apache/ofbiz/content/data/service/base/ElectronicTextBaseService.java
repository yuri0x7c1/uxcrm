...
public class ElectronicTextBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ElectronicTextBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ElectronicTexts
	 */
	...
	/**
	 * Find ElectronicTexts
	 */
	public List<ElectronicText> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ElectronicText> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ElectronicText.NAME);
		if (start == null) {
	...
	/**
	 * Find one ElectronicText
	 */
	public Optional<ElectronicText> findOne(Object dataResourceId) {
	 ...
	 * Get data resource
	 */
	public Optional<DataResource> getDataResource(ElectronicText electronicText) {
		List<DataResource> entityList = null;
		In in = new In();
		in.setEntityName(DataResource.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("dataResourceId", EntityOperator.EQUALS,
						electronicText.getDataResourceId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
