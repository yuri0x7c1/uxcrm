...
public class ProductCategoryRollupBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ProductCategoryRollupBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ProductCategoryRollups
	 */
	...
	/**
	 * Find ProductCategoryRollups
	 */
	public List<ProductCategoryRollup> find(Integer start, Integer number,
	...
	/**
	 * Find one ProductCategoryRollup
	 */
	public Optional<ProductCategoryRollup> findOne(Object productCategoryId,
			Object parentProductCategoryId, Object fromDate) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("productCategoryId", EntityOperator.EQUALS,
						...
						"parentProductCategoryId", EntityOperator.EQUALS,
						parentProductCategoryId), new EntityExpr("fromDate",
	 ...
	 */
	public Optional<ProductCategory> getCurrentProductCategory(
			ProductCategoryRollup productCategoryRollup) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productCategoryId",
						EntityOperator.EQUALS, productCategoryRollup
	 ...
	 */
	public List<ProductCategoryRollup> getChildProductCategoryRollups(
			ProductCategoryRollup productCategoryRollup, Integer start,
	...
	/**
	 * Get sibling product category rollups
	 */
	public List<ProductCategoryRollup> getSiblingProductCategoryRollups(
			ProductCategoryRollup productCategoryRollup, Integer start,
			Integer number, List<String> orderBy) {
		List<ProductCategoryRollup> entityList = Collections.emptyList();
		In in = new In();
