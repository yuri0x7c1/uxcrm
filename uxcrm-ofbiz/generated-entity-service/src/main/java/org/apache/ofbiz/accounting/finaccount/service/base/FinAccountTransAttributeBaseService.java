...
public class FinAccountTransAttributeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FinAccountTransAttributeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FinAccountTransAttributes
	 */
	...
	/**
	 * Find FinAccountTransAttributes
	 */
	public List<FinAccountTransAttribute> find(Integer start, Integer number,
	...
	/**
	 * Find one FinAccountTransAttribute
	 */
	public Optional<FinAccountTransAttribute> findOne(Object finAccountTransId,
			Object attrName) {
		List<FinAccountTransAttribute> entityList = null;
		In in = new In();
		in.setEntityName(FinAccountTransAttribute.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("finAccountTransId", EntityOperator.EQUALS,
						finAccountTransId), new EntityExpr("attrName",
	...
	public Optional<FinAccountTrans> getFinAccountTrans(
			FinAccountTransAttribute finAccountTransAttribute) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("finAccountTransId",
						EntityOperator.EQUALS, finAccountTransAttribute
	...
	public List<FinAccountTransTypeAttr> getFinAccountTransTypeAttrs(
			FinAccountTransAttribute finAccountTransAttribute, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("attrName", EntityOperator.EQUALS,
						finAccountTransAttribute.getAttrName())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
