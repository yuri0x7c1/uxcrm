...
public class SurveyQuestionOptionBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SurveyQuestionOptionBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SurveyQuestionOptions
	 */
	...
	/**
	 * Find SurveyQuestionOptions
	 */
	public List<SurveyQuestionOption> find(Integer start, Integer number,
	...
	/**
	 * Find one SurveyQuestionOption
	 */
	public Optional<SurveyQuestionOption> findOne(Object surveyQuestionId,
			Object surveyOptionSeqId) {
		List<SurveyQuestionOption> entityList = null;
		In in = new In();
		in.setEntityName(SurveyQuestionOption.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("surveyQuestionId", EntityOperator.EQUALS,
						surveyQuestionId), new EntityExpr("surveyOptionSeqId",
						EntityOperator.EQUALS, surveyOptionSeqId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<SurveyQuestion> getSurveyQuestion(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("surveyQuestionId",
						EntityOperator.EQUALS, surveyQuestionOption
	...
	/**
	 * Get with survey question appls
	 */
	public List<SurveyQuestionAppl> getWithSurveyQuestionAppls(
			SurveyQuestionOption surveyQuestionOption, Integer start,
		...
		in.setOrderByList(orderBy);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("withSurveyQuestionId", EntityOperator.EQUALS,
						surveyQuestionOption.getSurveyQuestionId()),
				new EntityExpr("withSurveyOptionSeqId", EntityOperator.EQUALS,
						surveyQuestionOption.getSurveyOptionSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
