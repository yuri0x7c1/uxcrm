...
public class PostalAddressBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PostalAddressBaseService(ExecuteFindService executeFindService) {
	...
	/**
	 * Find PostalAddresses
	 */
	public List<PostalAddress> find(Integer start, Integer number,
	...
	/**
	 * Find one PostalAddress
	 */
	public Optional<PostalAddress> findOne(Object contactMechId) {
	 ...
	 * Get contact mech
	 */
	public Optional<ContactMech> getContactMech(PostalAddress postalAddress) {
		List<ContactMech> entityList = null;
		In in = new In();
		in.setEntityName(ContactMech.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						postalAddress.getContactMechId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get country geo
	 */
	public Optional<Geo> getCountryGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("geoId", EntityOperator.EQUALS,
						postalAddress.getCountryGeoId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<Geo> getStateProvinceGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
	 ...
	 * Get county geo
	 */
	public Optional<Geo> getCountyGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("geoId", EntityOperator.EQUALS,
						postalAddress.getCountyGeoId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Geo.fromValues(out.getListIt().getCompleteList());
	...
	/**
	 * Get municipality geo
	 */
	public Optional<Geo> getMunicipalityGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("geoId", EntityOperator.EQUALS,
						postalAddress.getMunicipalityGeoId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get city geo
	 */
	public Optional<Geo> getCityGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("geoId", EntityOperator.EQUALS,
						postalAddress.getCityGeoId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Geo.fromValues(out.getListIt().getCompleteList());
	 ...
	 * Get postal code geo
	 */
	public Optional<Geo> getPostalCodeGeo(PostalAddress postalAddress) {
		List<Geo> entityList = null;
		In in = new In();
		in.setEntityName(Geo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("geoId", EntityOperator.EQUALS,
						postalAddress.getPostalCodeGeoId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public List<BillingAccount> getBillingAccounts(PostalAddress postalAddress,
	 ...
	 * Get check accounts
	 */
	public List<CheckAccount> getCheckAccounts(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 * Get credit cards
	 */
	public List<CreditCard> getCreditCards(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 * Get eft accounts
	 */
	public List<EftAccount> getEftAccounts(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 * Get gift cards
	 */
	public List<GiftCard> getGiftCards(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
	...
	public List<OrderItemShipGroup> getOrderItemShipGroups(
			PostalAddress postalAddress, Integer start, Integer number,
			List<String> orderBy) {
	 ...
	 * Get return headers
	 */
	public List<ReturnHeader> getReturnHeaders(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(
				Arrays.asList(new EntityExpr("originContactMechId",
						EntityOperator.EQUALS, postalAddress.getContactMechId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public List<Shipment> getOriginShipments(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<Shipment> getDestinationShipments(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
		List<Shipment> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(Shipment.NAME);
	 ...
	 * Get shopping lists
	 */
	public List<ShoppingList> getShoppingLists(PostalAddress postalAddress,
			Integer start, Integer number, List<String> orderBy) {
