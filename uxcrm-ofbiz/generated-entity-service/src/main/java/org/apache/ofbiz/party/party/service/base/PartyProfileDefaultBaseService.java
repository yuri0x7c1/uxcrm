...
public class PartyProfileDefaultBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyProfileDefaultBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyProfileDefaults
	 */
	...
	/**
	 * Find PartyProfileDefaults
	 */
	public List<PartyProfileDefault> find(Integer start, Integer number,
	...
	/**
	 * Find one PartyProfileDefault
	 */
	public Optional<PartyProfileDefault> findOne(Object partyId,
			Object productStoreId) {
		List<PartyProfileDefault> entityList = null;
		In in = new In();
		in.setEntityName(PartyProfileDefault.NAME);
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(PartyProfileDefault partyProfileDefault) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyProfileDefault.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	...
	public Optional<ProductStore> getProductStore(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productStoreId", EntityOperator.EQUALS,
						partyProfileDefault.getProductStoreId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
