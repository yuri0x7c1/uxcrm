...
public class GlAccountRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public GlAccountRoleBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count GlAccountRoles
	 */
	 ...
	 * Find GlAccountRoles
	 */
	public List<GlAccountRole> find(Integer start, Integer number,
	...
	/**
	 * Find one GlAccountRole
	 */
	public Optional<GlAccountRole> findOne(Object glAccountId, Object partyId,
			Object roleTypeId, Object fromDate) {
		List<GlAccountRole> entityList = null;
		In in = new In();
		in.setEntityName(GlAccountRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("glAccountId", EntityOperator.EQUALS,
						glAccountId), new EntityExpr("partyId",
	 ...
	 * Get gl account
	 */
	public Optional<GlAccount> getGlAccount(GlAccountRole glAccountRole) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glAccountId", EntityOperator.EQUALS,
						glAccountRole.getGlAccountId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(GlAccountRole glAccountRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						glAccountRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get party role
	 */
	public Optional<PartyRole> getPartyRole(GlAccountRole glAccountRole) {
		List<PartyRole> entityList = null;
		In in = new In();
		in.setEntityName(PartyRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, glAccountRole
						.getPartyId()), new EntityExpr("roleTypeId",
						EntityOperator.EQUALS, glAccountRole.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
