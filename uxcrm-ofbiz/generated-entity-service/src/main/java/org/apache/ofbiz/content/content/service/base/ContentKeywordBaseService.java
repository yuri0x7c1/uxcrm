...
public class ContentKeywordBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ContentKeywordBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ContentKeywords
	 */
	...
	/**
	 * Find ContentKeywords
	 */
	public List<ContentKeyword> find(Integer start, Integer number,
	...
	/**
	 * Find one ContentKeyword
	 */
	public Optional<ContentKeyword> findOne(Object contentId, Object keyword) {
		List<ContentKeyword> entityList = null;
		In in = new In();
		in.setEntityName(ContentKeyword.NAME);
	 ...
	 * Get content
	 */
	public Optional<Content> getContent(ContentKeyword contentKeyword) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentId", EntityOperator.EQUALS,
						contentKeyword.getContentId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
