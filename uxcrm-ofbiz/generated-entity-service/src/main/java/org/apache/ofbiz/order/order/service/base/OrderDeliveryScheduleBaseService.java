...
public class OrderDeliveryScheduleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderDeliveryScheduleBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderDeliverySchedules
	 */
	...
	/**
	 * Find OrderDeliverySchedules
	 */
	public List<OrderDeliverySchedule> find(Integer start, Integer number,
	...
	/**
	 * Find one OrderDeliverySchedule
	 */
	public Optional<OrderDeliverySchedule> findOne(Object orderId,
	...
	public Optional<OrderHeader> getOrderHeader(
			OrderDeliverySchedule orderDeliverySchedule) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						orderDeliverySchedule.getOrderId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderItem> getOrderItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("orderId", EntityOperator.EQUALS,
						orderDeliverySchedule.getOrderId()), new EntityExpr(
						"orderItemSeqId", EntityOperator.EQUALS,
						orderDeliverySchedule.getOrderItemSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get total cubic uom
	 */
	public Optional<Uom> getTotalCubicUom(
			OrderDeliverySchedule orderDeliverySchedule) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("uomId", EntityOperator.EQUALS,
						orderDeliverySchedule.getTotalCubicUomId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<Uom> getTotalWeightUom(
			OrderDeliverySchedule orderDeliverySchedule) {
		List<Uom> entityList = null;
		In in = new In();
		in.setEntityName(Uom.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("uomId", EntityOperator.EQUALS,
						orderDeliverySchedule.getTotalWeightUomId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<StatusItem> getStatusItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						orderDeliverySchedule.getStatusId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
