...
public class TrackingCodeOrderBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public TrackingCodeOrderBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count TrackingCodeOrders
	 */
	...
	/**
	 * Find TrackingCodeOrders
	 */
	public List<TrackingCodeOrder> find(Integer start, Integer number,
	...
	/**
	 * Find one TrackingCodeOrder
	 */
	public Optional<TrackingCodeOrder> findOne(Object orderId,
			Object trackingCodeTypeId) {
		List<TrackingCodeOrder> entityList = null;
		In in = new In();
		in.setEntityName(TrackingCodeOrder.NAME);
	...
	public Optional<OrderHeader> getOrderHeader(
			TrackingCodeOrder trackingCodeOrder) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						trackingCodeOrder.getOrderId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<TrackingCode> getTrackingCode(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trackingCodeId", EntityOperator.EQUALS,
						trackingCodeOrder.getTrackingCodeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<TrackingCodeType> getTrackingCodeType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("trackingCodeTypeId",
						EntityOperator.EQUALS, trackingCodeOrder
