...
public class AgreementTermAttributeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public AgreementTermAttributeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count AgreementTermAttributes
	 */
	...
	/**
	 * Find AgreementTermAttributes
	 */
	public List<AgreementTermAttribute> find(Integer start, Integer number,
	...
	/**
	 * Find one AgreementTermAttribute
	 */
	public Optional<AgreementTermAttribute> findOne(Object agreementTermId,
			Object attrName) {
		List<AgreementTermAttribute> entityList = null;
		In in = new In();
		in.setEntityName(AgreementTermAttribute.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("agreementTermId", EntityOperator.EQUALS,
						agreementTermId), new EntityExpr("attrName",
	 ...
	 * Get agreement term
	 */
	public Optional<AgreementTerm> getAgreementTerm(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("agreementTermId",
						EntityOperator.EQUALS, agreementTermAttribute
