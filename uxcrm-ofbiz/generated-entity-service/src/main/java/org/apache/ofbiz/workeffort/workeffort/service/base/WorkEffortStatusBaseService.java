...
public class WorkEffortStatusBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortStatusBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortStatuses
	 */
	...
	/**
	 * Find WorkEffortStatuses
	 */
	public List<WorkEffortStatus> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortStatus
	 */
	public Optional<WorkEffortStatus> findOne(Object workEffortId,
			Object statusId, Object statusDatetime) {
		List<WorkEffortStatus> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortStatus.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortId), new EntityExpr("statusId",
	 ...
	 * Get work effort
	 */
	public Optional<WorkEffort> getWorkEffort(WorkEffortStatus workEffortStatus) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortStatus.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get status item
	 */
	public Optional<StatusItem> getStatusItem(WorkEffortStatus workEffortStatus) {
		List<StatusItem> entityList = null;
		In in = new In();
		in.setEntityName(StatusItem.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						workEffortStatus.getStatusId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get set by user login
	 */
	public Optional<UserLogin> getSetByUserLogin(
			WorkEffortStatus workEffortStatus) {
		List<UserLogin> entityList = null;
		In in = new In();
		in.setEntityName(UserLogin.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("userLoginId", EntityOperator.EQUALS,
						workEffortStatus.getSetByUserLogin())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
