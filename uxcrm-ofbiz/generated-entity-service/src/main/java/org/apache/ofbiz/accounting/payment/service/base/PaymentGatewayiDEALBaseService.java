...
public class PaymentGatewayiDEALBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayiDEALBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayiDEALs
	 */
	...
	/**
	 * Find PaymentGatewayiDEALs
	 */
	public List<PaymentGatewayiDEAL> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayiDEAL> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayiDEAL.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayiDEAL
	 */
	public Optional<PaymentGatewayiDEAL> findOne(Object paymentGatewayConfigId) {
