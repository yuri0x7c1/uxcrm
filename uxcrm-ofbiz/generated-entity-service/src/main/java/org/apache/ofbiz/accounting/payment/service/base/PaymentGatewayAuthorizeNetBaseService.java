...
public class PaymentGatewayAuthorizeNetBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayAuthorizeNetBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayAuthorizeNets
	 */
	...
	/**
	 * Find PaymentGatewayAuthorizeNets
	 */
	public List<PaymentGatewayAuthorizeNet> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayAuthorizeNet> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayAuthorizeNet.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayAuthorizeNet
	 */
	public Optional<PaymentGatewayAuthorizeNet> findOne(
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewayAuthorizeNet paymentGatewayAuthorizeNet) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewayAuthorizeNet
