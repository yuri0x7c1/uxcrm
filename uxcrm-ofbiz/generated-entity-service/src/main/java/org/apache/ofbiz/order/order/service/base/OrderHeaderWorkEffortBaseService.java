...
public class OrderHeaderWorkEffortBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public OrderHeaderWorkEffortBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count OrderHeaderWorkEfforts
	 */
	...
	/**
	 * Find OrderHeaderWorkEfforts
	 */
	public List<OrderHeaderWorkEffort> find(Integer start, Integer number,
	...
	/**
	 * Find one OrderHeaderWorkEffort
	 */
	public Optional<OrderHeaderWorkEffort> findOne(Object orderId,
			Object workEffortId) {
		List<OrderHeaderWorkEffort> entityList = null;
		In in = new In();
		in.setEntityName(OrderHeaderWorkEffort.NAME);
	...
	public Optional<OrderHeader> getOrderHeader(
			OrderHeaderWorkEffort orderHeaderWorkEffort) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("orderId", EntityOperator.EQUALS,
						orderHeaderWorkEffort.getOrderId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<WorkEffort> getWorkEffort(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						orderHeaderWorkEffort.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
