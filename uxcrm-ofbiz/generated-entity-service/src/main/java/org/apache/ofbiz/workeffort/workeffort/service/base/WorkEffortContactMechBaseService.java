...
public class WorkEffortContactMechBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortContactMechBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortContactMeches
	 */
	...
	/**
	 * Find WorkEffortContactMeches
	 */
	public List<WorkEffortContactMech> find(Integer start, Integer number,
	...
	/**
	 * Find one WorkEffortContactMech
	 */
	public Optional<WorkEffortContactMech> findOne(Object workEffortId,
			Object contactMechId, Object fromDate) {
		List<WorkEffortContactMech> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffortContactMech.NAME);
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortContactMech workEffortContactMech) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortContactMech.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<ContactMech> getContactMech(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						workEffortContactMech.getContactMechId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
