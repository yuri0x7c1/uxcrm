...
public class FacilityGroupRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FacilityGroupRoleBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FacilityGroupRoles
	 */
	...
	/**
	 * Find FacilityGroupRoles
	 */
	public List<FacilityGroupRole> find(Integer start, Integer number,
	...
	/**
	 * Find one FacilityGroupRole
	 */
	public Optional<FacilityGroupRole> findOne(Object facilityGroupId,
			Object partyId, Object roleTypeId) {
		List<FacilityGroupRole> entityList = null;
		In in = new In();
		in.setEntityName(FacilityGroupRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("facilityGroupId", EntityOperator.EQUALS,
						facilityGroupId), new EntityExpr("partyId",
	 ...
	 * Get party role
	 */
	public Optional<PartyRole> getPartyRole(FacilityGroupRole facilityGroupRole) {
		List<PartyRole> entityList = null;
		In in = new In();
		in.setEntityName(PartyRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS,
						facilityGroupRole.getPartyId()),
				new EntityExpr("roleTypeId", EntityOperator.EQUALS,
						facilityGroupRole.getRoleTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(FacilityGroupRole facilityGroupRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						facilityGroupRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get role type
	 */
	public Optional<RoleType> getRoleType(FacilityGroupRole facilityGroupRole) {
