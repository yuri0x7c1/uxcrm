...
public class ContentRoleBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ContentRoleBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find ContentRoles
	 */
	public List<ContentRole> find(Integer start, Integer number,
	...
	/**
	 * Find one ContentRole
	 */
	public Optional<ContentRole> findOne(Object contentId, Object partyId,
			Object roleTypeId, Object fromDate) {
		List<ContentRole> entityList = null;
		In in = new In();
		in.setEntityName(ContentRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentId", EntityOperator.EQUALS,
						contentId), new EntityExpr("partyId",
	 ...
	 * Get content
	 */
	public Optional<Content> getContent(ContentRole contentRole) {
		List<Content> entityList = null;
		In in = new In();
		in.setEntityName(Content.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contentId", EntityOperator.EQUALS,
						contentRole.getContentId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get party
	 */
	public Optional<Party> getParty(ContentRole contentRole) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						contentRole.getPartyId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get party role
	 */
	public Optional<PartyRole> getPartyRole(ContentRole contentRole) {
		List<PartyRole> entityList = null;
		In in = new In();
		in.setEntityName(PartyRole.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("partyId", EntityOperator.EQUALS, contentRole
						.getPartyId()), new EntityExpr("roleTypeId",
						EntityOperator.EQUALS, contentRole.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
