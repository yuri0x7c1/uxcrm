...
public class BudgetScenarioBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public BudgetScenarioBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count BudgetScenarios
	 */
	...
	/**
	 * Find BudgetScenarios
	 */
	public List<BudgetScenario> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<BudgetScenario> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(BudgetScenario.NAME);
		if (start == null) {
	...
	/**
	 * Find one BudgetScenario
	 */
	public Optional<BudgetScenario> findOne(Object budgetScenarioId) {
		List<BudgetScenario> entityList = null;
		In in = new In();
		in.setEntityName(BudgetScenario.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("budgetScenarioId",
						EntityOperator.EQUALS, budgetScenarioId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<BudgetScenarioApplication> getBudgetScenarioApplications(
			BudgetScenario budgetScenario, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("budgetScenarioId",
						EntityOperator.EQUALS, budgetScenario
