...
public class CreditCardBaseService {
	...
	@Autowired
	public CreditCardBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find CreditCards
	 */
	public List<CreditCard> find(Integer start, Integer number,
	 ...
	 * Find one CreditCard
	 */
	public Optional<CreditCard> findOne(Object paymentMethodId) {
	 ...
	 * Get payment method
	 */
	public Optional<PaymentMethod> getPaymentMethod(CreditCard creditCard) {
		...
		in.setEntityConditionList(new EntityConditionList<>(
				Arrays.asList(new EntityExpr("paymentMethodId",
						EntityOperator.EQUALS, creditCard.getPaymentMethodId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get contact mech
	 */
	public Optional<ContactMech> getContactMech(CreditCard creditCard) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						creditCard.getContactMechId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get postal address
	 */
	public Optional<PostalAddress> getPostalAddress(CreditCard creditCard) {
	...
	public List<OrderPaymentPreference> getOrderPaymentPreferences(
			CreditCard creditCard, Integer start, Integer number,
			List<String> orderBy) {
	 ...
	 * Get payments
	 */
	public List<Payment> getPayments(CreditCard creditCard, Integer start,
