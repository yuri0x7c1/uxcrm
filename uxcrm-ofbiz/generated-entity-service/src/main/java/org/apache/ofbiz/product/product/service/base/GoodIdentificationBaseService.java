...
public class GoodIdentificationBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public GoodIdentificationBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count GoodIdentifications
	 */
	...
	/**
	 * Find GoodIdentifications
	 */
	public List<GoodIdentification> find(Integer start, Integer number,
	...
	/**
	 * Find one GoodIdentification
	 */
	public Optional<GoodIdentification> findOne(
			Object goodIdentificationTypeId, Object productId) {
		List<GoodIdentification> entityList = null;
		In in = new In();
		in.setEntityName(GoodIdentification.NAME);
	 ...
	 */
	public Optional<GoodIdentificationType> getGoodIdentificationType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("goodIdentificationTypeId",
						EntityOperator.EQUALS, goodIdentification
	 ...
	 * Get product
	 */
	public Optional<Product> getProduct(GoodIdentification goodIdentification) {
		List<Product> entityList = null;
		In in = new In();
		in.setEntityName(Product.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productId", EntityOperator.EQUALS,
						goodIdentification.getProductId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
