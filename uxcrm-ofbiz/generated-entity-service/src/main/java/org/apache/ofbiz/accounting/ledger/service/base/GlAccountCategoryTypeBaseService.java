...
public class GlAccountCategoryTypeBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public GlAccountCategoryTypeBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count GlAccountCategoryTypes
	 */
	...
	/**
	 * Find GlAccountCategoryTypes
	 */
	public List<GlAccountCategoryType> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<GlAccountCategoryType> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(GlAccountCategoryType.NAME);
		if (start == null) {
	...
	/**
	 * Find one GlAccountCategoryType
	 */
	public Optional<GlAccountCategoryType> findOne(
			Object glAccountCategoryTypeId) {
		List<GlAccountCategoryType> entityList = null;
		In in = new In();
		in.setEntityName(GlAccountCategoryType.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glAccountCategoryTypeId",
						EntityOperator.EQUALS, glAccountCategoryTypeId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<GlAccountCategory> getGlAccountCategories(
			GlAccountCategoryType glAccountCategoryType, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glAccountCategoryTypeId",
						EntityOperator.EQUALS, glAccountCategoryType
