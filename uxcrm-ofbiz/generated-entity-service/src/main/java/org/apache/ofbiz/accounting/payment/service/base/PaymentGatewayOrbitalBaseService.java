...
public class PaymentGatewayOrbitalBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PaymentGatewayOrbitalBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PaymentGatewayOrbitals
	 */
	...
	/**
	 * Find PaymentGatewayOrbitals
	 */
	public List<PaymentGatewayOrbital> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<PaymentGatewayOrbital> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(PaymentGatewayOrbital.NAME);
		if (start == null) {
	...
	/**
	 * Find one PaymentGatewayOrbital
	 */
	public Optional<PaymentGatewayOrbital> findOne(Object paymentGatewayConfigId) {
	...
	public Optional<PaymentGatewayConfig> getPaymentGatewayConfig(
			PaymentGatewayOrbital paymentGatewayOrbital) {
		List<PaymentGatewayConfig> entityList = null;
		In in = new In();
		in.setEntityName(PaymentGatewayConfig.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("paymentGatewayConfigId",
						EntityOperator.EQUALS, paymentGatewayOrbital
