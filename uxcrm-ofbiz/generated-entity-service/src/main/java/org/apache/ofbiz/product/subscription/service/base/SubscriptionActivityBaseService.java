...
public class SubscriptionActivityBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public SubscriptionActivityBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count SubscriptionActivities
	 */
	...
	/**
	 * Find SubscriptionActivities
	 */
	public List<SubscriptionActivity> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<SubscriptionActivity> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(SubscriptionActivity.NAME);
		if (start == null) {
	...
	/**
	 * Find one SubscriptionActivity
	 */
	public Optional<SubscriptionActivity> findOne(Object subscriptionActivityId) {
		List<SubscriptionActivity> entityList = null;
		In in = new In();
		in.setEntityName(SubscriptionActivity.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("subscriptionActivityId",
						EntityOperator.EQUALS, subscriptionActivityId)),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public List<SubscriptionFulfillmentPiece> getSubscriptionFulfillmentPieces(
			SubscriptionActivity subscriptionActivity, Integer start,
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("subscriptionActivityId",
						EntityOperator.EQUALS, subscriptionActivity
