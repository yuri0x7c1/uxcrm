...
public class PartyFixedAssetAssignmentBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public PartyFixedAssetAssignmentBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count PartyFixedAssetAssignments
	 */
	...
	/**
	 * Find PartyFixedAssetAssignments
	 */
	public List<PartyFixedAssetAssignment> find(Integer start, Integer number,
	...
	/**
	 * Find one PartyFixedAssetAssignment
	 */
	public Optional<PartyFixedAssetAssignment> findOne(Object partyId,
			Object roleTypeId, Object fixedAssetId, Object fromDate) {
		List<PartyFixedAssetAssignment> entityList = null;
		In in = new In();
		in.setEntityName(PartyFixedAssetAssignment.NAME);
	...
	public Optional<Party> getParty(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						partyFixedAssetAssignment.getPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<RoleType> getRoleType(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("roleTypeId", EntityOperator.EQUALS,
						partyFixedAssetAssignment.getRoleTypeId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<FixedAsset> getFixedAsset(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("fixedAssetId", EntityOperator.EQUALS,
						partyFixedAssetAssignment.getFixedAssetId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<StatusItem> getStatusItem(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						partyFixedAssetAssignment.getStatusId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
