...
public class ShipmentBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ShipmentBaseService(ExecuteFindService executeFindService) {
	 ...
	 * Find Shipments
	 */
	public List<Shipment> find(Integer start, Integer number,
	 ...
	 * Get shipment type
	 */
	public Optional<ShipmentType> getShipmentType(Shipment shipment) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shipmentTypeId", EntityOperator.EQUALS,
						shipment.getShipmentTypeId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get status item
	 */
	public Optional<StatusItem> getStatusItem(Shipment shipment) {
		List<StatusItem> entityList = null;
		In in = new In();
		in.setEntityName(StatusItem.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("statusId", EntityOperator.EQUALS,
						shipment.getStatusId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get estimated ship work effort
	 */
	public Optional<WorkEffort> getEstimatedShipWorkEffort(Shipment shipment) {
		List<WorkEffort> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffort.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						shipment.getEstimatedShipWorkEffId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	/**
	 * Get estimated arrival work effort
	 */
	public Optional<WorkEffort> getEstimatedArrivalWorkEffort(Shipment shipment) {
		List<WorkEffort> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffort.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						shipment.getEstimatedArrivalWorkEffId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get currency uom
	 */
	public Optional<Uom> getCurrencyUom(Shipment shipment) {
		List<Uom> entityList = null;
		In in = new In();
		in.setEntityName(Uom.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("uomId", EntityOperator.EQUALS, shipment
	 ...
	 */
	public Optional<Facility> getDestinationFacility(Shipment shipment) {
		List<Facility> entityList = null;
		In in = new In();
		in.setEntityName(Facility.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("facilityId", EntityOperator.EQUALS,
						shipment.getDestinationFacilityId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<ContactMech> getOriginContactMech(Shipment shipment) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						shipment.getOriginContactMechId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<ContactMech> getDestContactMech(Shipment shipment) {
		List<ContactMech> entityList = null;
		In in = new In();
		in.setEntityName(ContactMech.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						shipment.getDestinationContactMechId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<PostalAddress> getOriginPostalAddress(Shipment shipment) {
	 ...
	 */
	public Optional<TelecomNumber> getOriginTelecomNumber(Shipment shipment) {
		List<TelecomNumber> entityList = null;
		In in = new In();
		in.setEntityName(TelecomNumber.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						shipment.getOriginTelecomNumberId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public Optional<PostalAddress> getDestinationPostalAddress(Shipment shipment) {
		List<PostalAddress> entityList = null;
		In in = new In();
		in.setEntityName(PostalAddress.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
	 ...
	 */
	public Optional<TelecomNumber> getDestinationTelecomNumber(Shipment shipment) {
		List<TelecomNumber> entityList = null;
		In in = new In();
		in.setEntityName(TelecomNumber.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("contactMechId", EntityOperator.EQUALS,
						shipment.getDestinationTelecomNumberId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get picklist bin
	 */
	public Optional<PicklistBin> getPicklistBin(Shipment shipment) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("picklistBinId", EntityOperator.EQUALS,
						shipment.getPicklistBinId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<OrderItemShipGroup> getPrimaryOrderItemShipGroup(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("orderId", EntityOperator.EQUALS, shipment
						.getPrimaryOrderId()),
				new EntityExpr("shipGroupSeqId", EntityOperator.EQUALS,
						shipment.getPrimaryShipGroupSeqId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 */
	public List<ShipmentTypeAttr> getShipmentTypeAttrs(Shipment shipment,
	 ...
	 * Get to party
	 */
	public Optional<Party> getToParty(Shipment shipment) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						shipment.getPartyIdTo())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get to person
	 */
	public Optional<Person> getToPerson(Shipment shipment) {
	 ...
	 * Get to party group
	 */
	public Optional<PartyGroup> getToPartyGroup(Shipment shipment) {
	 ...
	 * Get from party
	 */
	public Optional<Party> getFromParty(Shipment shipment) {
		List<Party> entityList = null;
		In in = new In();
		in.setEntityName(Party.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						shipment.getPartyIdFrom())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
				entityList = Party
	 ...
	 * Get from person
	 */
	public Optional<Person> getFromPerson(Shipment shipment) {
		List<Person> entityList = null;
		In in = new In();
		in.setEntityName(Person.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
	 ...
	 */
	public Optional<PartyGroup> getFromPartyGroup(Shipment shipment) {
		List<PartyGroup> entityList = null;
		In in = new In();
		in.setEntityName(PartyGroup.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
	...
	/**
	 * Get shipment manifest views
	 */
	public List<ShipmentManifestView> getShipmentManifestViews(
			Shipment shipment, Integer start, Integer number,
			List<String> orderBy) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("shipmentId", EntityOperator.EQUALS,
						shipment.getShipmentId())), EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	 ...
	 * Get acctg transes
	 */
	public List<AcctgTrans> getAcctgTranses(Shipment shipment, Integer start,
	 ...
	 * Get item issuances
	 */
	public List<ItemIssuance> getItemIssuances(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 * Get order shipments
	 */
	public List<OrderShipment> getOrderShipments(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ReturnItemShipment> getReturnItemShipments(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentAttribute> getShipmentAttributes(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentItemBilling> getShipmentItemBillings(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentItemFeature> getShipmentItemFeatures(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentPackage> getShipmentPackages(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentReceipt> getShipmentReceipts(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
	 ...
	 */
	public List<ShipmentStatus> getShipmentStatuses(Shipment shipment,
			Integer start, Integer number, List<String> orderBy) {
