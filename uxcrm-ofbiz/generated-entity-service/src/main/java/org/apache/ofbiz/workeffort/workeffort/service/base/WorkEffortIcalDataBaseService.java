...
public class WorkEffortIcalDataBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public WorkEffortIcalDataBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count WorkEffortIcalDatas
	 */
	...
	/**
	 * Find WorkEffortIcalDatas
	 */
	public List<WorkEffortIcalData> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<WorkEffortIcalData> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(WorkEffortIcalData.NAME);
		if (start == null) {
	...
	/**
	 * Find one WorkEffortIcalData
	 */
	public Optional<WorkEffortIcalData> findOne(Object workEffortId) {
	...
	public Optional<WorkEffort> getWorkEffort(
			WorkEffortIcalData workEffortIcalData) {
		List<WorkEffort> entityList = null;
		In in = new In();
		in.setEntityName(WorkEffort.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("workEffortId", EntityOperator.EQUALS,
						workEffortIcalData.getWorkEffortId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
