...
public class FinAccountTypeGlAccountBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public FinAccountTypeGlAccountBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count FinAccountTypeGlAccounts
	 */
	...
	/**
	 * Find FinAccountTypeGlAccounts
	 */
	public List<FinAccountTypeGlAccount> find(Integer start, Integer number,
	...
	/**
	 * Find one FinAccountTypeGlAccount
	 */
	public Optional<FinAccountTypeGlAccount> findOne(Object finAccountTypeId,
			Object organizationPartyId) {
		List<FinAccountTypeGlAccount> entityList = null;
		In in = new In();
		in.setEntityName(FinAccountTypeGlAccount.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("finAccountTypeId", EntityOperator.EQUALS,
						finAccountTypeId), new EntityExpr(
	...
	public Optional<Party> getOrganizationParty(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("partyId", EntityOperator.EQUALS,
						finAccountTypeGlAccount.getOrganizationPartyId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
	...
	public Optional<GlAccount> getGlAccount(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("glAccountId", EntityOperator.EQUALS,
						finAccountTypeGlAccount.getGlAccountId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
