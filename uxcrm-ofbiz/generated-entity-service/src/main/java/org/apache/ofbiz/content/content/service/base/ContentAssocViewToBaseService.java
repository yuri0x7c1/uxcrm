...
import org.apache.ofbiz.content.content.ContentAssocViewTo;
import org.springframework.beans.factory.annotation.Autowired;

@Slf4j
@Component
@SuppressWarnings("unchecked")
public class ContentAssocViewToBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public ContentAssocViewToBaseService(ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count ContentAssocViewToes
	 */
	public Integer count(EntityConditionList conditions) {
		In in = new In();
		in.setEntityName(ContentAssocViewTo.NAME);
		if (conditions == null) {
	...
	/**
	 * Find ContentAssocViewToes
	 */
	public List<ContentAssocViewTo> find(Integer start, Integer number,
			List<String> orderBy, EntityConditionList conditions) {
		List<ContentAssocViewTo> entityList = Collections.emptyList();
		In in = new In();
		in.setEntityName(ContentAssocViewTo.NAME);
		if (start == null) {
		...
		try {
			if (out.getListIt() != null) {
				entityList = ContentAssocViewTo.fromValues(out.getListIt()
	...
	/**
	 * Find one ContentAssocViewTo
	 */
	public Optional<ContentAssocViewTo> findOne(Object contentIdStart,
			Object fromDate, Object contentId, Object caContentIdTo,
			Object caContentId, Object caFromDate, Object caContentAssocTypeId) {
		List<ContentAssocViewTo> entityList = null;
		In in = new In();
		in.setEntityName(ContentAssocViewTo.NAME);
