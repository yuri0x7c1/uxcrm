...
public class MarketingCampaignPromoBaseService {

	protected ExecuteFindService executeFindService;

	@Autowired
	public MarketingCampaignPromoBaseService(
			ExecuteFindService executeFindService) {
		this.executeFindService = executeFindService;
	}

	/**
	 * Count MarketingCampaignPromoes
	 */
	...
	/**
	 * Find MarketingCampaignPromoes
	 */
	public List<MarketingCampaignPromo> find(Integer start, Integer number,
	...
	/**
	 * Find one MarketingCampaignPromo
	 */
	public Optional<MarketingCampaignPromo> findOne(Object marketingCampaignId,
			Object productPromoId) {
		List<MarketingCampaignPromo> entityList = null;
		In in = new In();
		in.setEntityName(MarketingCampaignPromo.NAME);
		in.setEntityConditionList(new EntityConditionList<>(Arrays.asList(
				new EntityExpr("marketingCampaignId", EntityOperator.EQUALS,
						marketingCampaignId), new EntityExpr("productPromoId",
	...
	public Optional<MarketingCampaign> getMarketingCampaign(
			MarketingCampaignPromo marketingCampaignPromo) {
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("marketingCampaignId",
						EntityOperator.EQUALS, marketingCampaignPromo
	...
	public Optional<ProductPromo> getProductPromo(
		...
		in.setEntityConditionList(new EntityConditionList<>(Arrays
				.asList(new EntityExpr("productPromoId", EntityOperator.EQUALS,
						marketingCampaignPromo.getProductPromoId())),
				EntityOperator.AND));
		Out out = executeFindService.runSync(in);
		try {
			if (out.getListIt() != null) {
