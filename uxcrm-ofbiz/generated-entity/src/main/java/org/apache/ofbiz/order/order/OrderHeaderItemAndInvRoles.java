...
/**
 * Order Header Item And Inv Roles
 */
public class OrderHeaderItemAndInvRoles implements Serializable {
	...
	public static OrderHeaderItemAndInvRoles fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new OrderHeaderItemAndInvRoles(value);
	}

	public static List<OrderHeaderItemAndInvRoles> fromValues(
			List<GenericValue> values) {
		List<OrderHeaderItemAndInvRoles> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new OrderHeaderItemAndInvRoles(value));
		}
		return entities;
	}
}