...
/**
 * Agreement Content And Info
 */
public class AgreementContentAndInfo implements Serializable {

	public static final long serialVersionUID = 7918168441506251776L;
	public static final String NAME = "AgreementContentAndInfo";
	/**
	 * From Date
	 */
	@Getter
	...
	public enum Fields {
		fromDate, agreementId, contentId, agreementItemSeqId, agreementContentTypeId, thruDate, ownerContentId, contentTypeId, description, mimeTypeId, childLeafCount, privilegeEnumId, dataSourceId, lastModifiedByUserLogin, dataResourceId, createdByUserLogin, templateDataResourceId, lastModifiedDate, instanceOfContentId, serviceName, customMethodId, characterSetId, contentName, createdDate, statusId, localeString, decoratorContentId, childBranchCount, drDataResourceName, drSurveyId, drDataTemplateTypeId, drLastModifiedDate, drMimeTypeId, drDataCategoryId, drSurveyResponseId, drCharacterSetId, drDataSourceId, drLastModifiedByUserLogin, drCreatedDate, drStatusId, drLocaleString, drRelatedDetailId, drDataResourceId, drIsPublic, drObjectInfo, drDataResourceTypeId, drCreatedByUserLogin
	}

	public AgreementContentAndInfo(GenericValue value) {
	...
	public static AgreementContentAndInfo fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new AgreementContentAndInfo(value);
	}

	public static List<AgreementContentAndInfo> fromValues(
			List<GenericValue> values) {
		List<AgreementContentAndInfo> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new AgreementContentAndInfo(value));
		}
		return entities;
	}
}