...
/**
 * Work Effort And Time Entry
 */
public class WorkEffortAndTimeEntry implements Serializable {

	public static final long serialVersionUID = 5727823203543336960L;
	public static final String NAME = "WorkEffortAndTimeEntry";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static WorkEffortAndTimeEntry fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortAndTimeEntry(value);
	}

	public static List<WorkEffortAndTimeEntry> fromValues(
			List<GenericValue> values) {
		List<WorkEffortAndTimeEntry> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortAndTimeEntry(value));
		}
		return entities;
	}
}