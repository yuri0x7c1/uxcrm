...
public class CommunicationEventAndRole implements Serializable {
	...
	public static final long serialVersionUID = 7262889459760394240L;
	...
	public enum Fields {
		partyId, roleTypeId, roleStatusId, contactMechId, partyIdFrom, note, subject, ccString, contactMechTypeId, communicationEventTypeId, content, contentMimeTypeId, datetimeStarted, contactListId, contactMechIdFrom, reasonEnumId, roleTypeIdTo, parentCommEventId, entryDate, datetimeEnded, origCommEventId, messageId, roleTypeIdFrom, contactMechIdTo, headerString, statusId, communicationEventId, bccString, partyIdTo, toString, fromString
	}

	public CommunicationEventAndRole(GenericValue value) {
		partyId = (String) value.get(Fields.partyId.name());
		roleTypeId = (String) value.get(Fields.roleTypeId.name());
		roleStatusId = (String) value.get(Fields.roleStatusId.name());
