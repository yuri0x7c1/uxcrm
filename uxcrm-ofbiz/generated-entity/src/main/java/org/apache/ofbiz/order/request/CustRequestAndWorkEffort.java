...
/**
 * Cust Request And Work Effort
 */
public class CustRequestAndWorkEffort implements Serializable {

	public static final long serialVersionUID = 2403323358051122176L;
	public static final String NAME = "CustRequestAndWorkEffort";
	/**
	 * Cust Request Id
	 */
	@Getter
	...
	public static CustRequestAndWorkEffort fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new CustRequestAndWorkEffort(value);
	}

	public static List<CustRequestAndWorkEffort> fromValues(
			List<GenericValue> values) {
		List<CustRequestAndWorkEffort> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new CustRequestAndWorkEffort(value));
		}
		return entities;
	}
}