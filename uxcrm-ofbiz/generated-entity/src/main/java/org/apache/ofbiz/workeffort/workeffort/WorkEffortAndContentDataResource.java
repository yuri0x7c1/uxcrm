...
/**
 * Work Effort And Content Data Resource
 */
public class WorkEffortAndContentDataResource implements Serializable {

	public static final long serialVersionUID = 3255178510611918848L;
	public static final String NAME = "WorkEffortAndContentDataResource";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static WorkEffortAndContentDataResource fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortAndContentDataResource(value);
	}

	public static List<WorkEffortAndContentDataResource> fromValues(
			List<GenericValue> values) {
		List<WorkEffortAndContentDataResource> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortAndContentDataResource(value));
		}
		return entities;
	}
}