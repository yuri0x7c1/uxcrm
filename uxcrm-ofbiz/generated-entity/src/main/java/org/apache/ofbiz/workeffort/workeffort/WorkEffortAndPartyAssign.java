...
/**
 * Work Effort And Party Assign
 */
public class WorkEffortAndPartyAssign implements Serializable {

	public static final long serialVersionUID = 7222285412838405120L;
	public static final String NAME = "WorkEffortAndPartyAssign";
	/**
	...
	public static WorkEffortAndPartyAssign fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortAndPartyAssign(value);
	}

	public static List<WorkEffortAndPartyAssign> fromValues(
			List<GenericValue> values) {
		List<WorkEffortAndPartyAssign> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortAndPartyAssign(value));
		}
		return entities;
	}
}