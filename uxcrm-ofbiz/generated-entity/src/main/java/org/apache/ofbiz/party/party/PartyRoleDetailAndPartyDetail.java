...
/**
 * Party Role Detail And Party Detail
 */
public class PartyRoleDetailAndPartyDetail implements Serializable {

	public static final long serialVersionUID = 4002387089579745280L;
	public static final String NAME = "PartyRoleDetailAndPartyDetail";
	/**
	 * Person Comments
	 */
	@Getter
	...
	public PartyRoleDetailAndPartyDetail(GenericValue value) {
	...
	public static PartyRoleDetailAndPartyDetail fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new PartyRoleDetailAndPartyDetail(value);
	}

	public static List<PartyRoleDetailAndPartyDetail> fromValues(
			List<GenericValue> values) {
		List<PartyRoleDetailAndPartyDetail> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new PartyRoleDetailAndPartyDetail(value));
		}
		return entities;
	}
}