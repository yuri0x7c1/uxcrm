...
/**
 * Work Effort Party Assign By Group
 */
public class WorkEffortPartyAssignByGroup implements Serializable {

	public static final long serialVersionUID = 1529397114434549760L;
	public static final String NAME = "WorkEffortPartyAssignByGroup";
	/**
	...
	public static WorkEffortPartyAssignByGroup fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortPartyAssignByGroup(value);
	}

	public static List<WorkEffortPartyAssignByGroup> fromValues(
			List<GenericValue> values) {
		List<WorkEffortPartyAssignByGroup> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortPartyAssignByGroup(value));
		}
		return entities;
	}
}