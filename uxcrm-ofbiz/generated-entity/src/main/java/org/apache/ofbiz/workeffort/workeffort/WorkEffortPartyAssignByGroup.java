...
public class WorkEffortPartyAssignByGroup implements Serializable {
	...
	public static final long serialVersionUID = 5291552158377518080L;
	...
	public WorkEffortPartyAssignByGroup(GenericValue value) {
		...
		groupPartyId = (String) value.get(FIELD_GROUP_PARTY_ID);
		prelFromDate = (Timestamp) value.get(FIELD_PREL_FROM_DATE);
		prelThruDate = (Timestamp) value.get(FIELD_PREL_THRU_DATE);
		prelStatusId = (String) value.get(FIELD_PREL_STATUS_ID);
		prelComments = (String) value.get(FIELD_PREL_COMMENTS);
