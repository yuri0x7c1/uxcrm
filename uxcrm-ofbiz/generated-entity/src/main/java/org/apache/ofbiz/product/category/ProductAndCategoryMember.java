...
/**
 * Product And Category Member
 */
public class ProductAndCategoryMember implements Serializable {

	public static final long serialVersionUID = 8176806643601746944L;
	public static final String NAME = "ProductAndCategoryMember";
	/**
	 * Member Comments
	 */
	@Getter
	...
	public static ProductAndCategoryMember fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProductAndCategoryMember(value);
	}

	public static List<ProductAndCategoryMember> fromValues(
			List<GenericValue> values) {
		List<ProductAndCategoryMember> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProductAndCategoryMember(value));
		}
		return entities;
	}
}