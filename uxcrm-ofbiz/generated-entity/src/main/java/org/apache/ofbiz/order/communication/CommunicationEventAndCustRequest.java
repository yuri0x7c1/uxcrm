package org.apache.ofbiz.order.communication;
...
/**
 * Communication Event And Cust Request
 */
public class CommunicationEventAndCustRequest implements Serializable {

	public static final long serialVersionUID = 5168620402403976192L;
	public static final String NAME = "CommunicationEventAndCustRequest";
	/**
	 * Cust Request Id
	 */
	@Getter
	...
	public CommunicationEventAndCustRequest(GenericValue value) {
	...
	public static CommunicationEventAndCustRequest fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new CommunicationEventAndCustRequest(value);
	}

	public static List<CommunicationEventAndCustRequest> fromValues(
			List<GenericValue> values) {
		List<CommunicationEventAndCustRequest> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new CommunicationEventAndCustRequest(value));
		}
		return entities;
	}
}