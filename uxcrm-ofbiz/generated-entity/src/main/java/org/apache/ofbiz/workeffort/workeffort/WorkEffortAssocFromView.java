...
/**
 * Work Effort Assoc From View
 */
public class WorkEffortAssocFromView implements Serializable {

	public static final long serialVersionUID = 7630988357012699136L;
	public static final String NAME = "WorkEffortAssocFromView";
	/**
	 * Work Effort Id To
	 */
	@Getter
	...
	public static WorkEffortAssocFromView fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortAssocFromView(value);
	}

	public static List<WorkEffortAssocFromView> fromValues(
			List<GenericValue> values) {
		List<WorkEffortAssocFromView> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortAssocFromView(value));
		}
		return entities;
	}
}