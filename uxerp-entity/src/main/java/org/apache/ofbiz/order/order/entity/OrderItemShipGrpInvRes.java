...
public class OrderItemShipGrpInvRes implements Serializable {
	...
	public static final long serialVersionUID = 9056583581835836416L;
	...
	public enum Fields {
		orderId, shipGroupSeqId, orderItemSeqId, inventoryItemId, reserveOrderEnumId, quantity, quantityNotAvailable, reservedDatetime, createdDatetime, promisedDatetime, currentPromisedDate, priority, sequenceId, oldPickStartDate
	}
