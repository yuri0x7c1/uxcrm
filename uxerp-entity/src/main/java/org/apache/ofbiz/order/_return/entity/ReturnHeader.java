...
public class ReturnHeader implements Serializable {
	...
	public static final long serialVersionUID = 3153035157498681344L;
	...
	public enum Fields {
		returnId, returnHeaderTypeId, statusId, createdBy, fromPartyId, toPartyId, paymentMethodId, finAccountId, billingAccountId, entryDate, originContactMechId, destinationFacilityId, needsInventoryReceive, currencyUomId, supplierRmaId
	}
