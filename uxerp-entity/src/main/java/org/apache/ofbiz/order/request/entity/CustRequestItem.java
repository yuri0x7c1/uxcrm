...
public class CustRequestItem implements Serializable {
	...
	public static final long serialVersionUID = 3464905331566249984L;
	...
	public enum Fields {
		custRequestId, custRequestItemSeqId, custRequestResolutionId, statusId, priority, sequenceNum, requiredByDate, productId, quantity, selectedAmount, maximumAmount, reservStart, reservLength, reservPersons, configId, description, story
	}
