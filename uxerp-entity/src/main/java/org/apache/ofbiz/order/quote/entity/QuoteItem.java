...
public class QuoteItem implements Serializable {
	...
	public static final long serialVersionUID = 3534280351474035712L;
	...
	public enum Fields {
		quoteId, quoteItemSeqId, productId, productFeatureId, deliverableTypeId, skillTypeId, uomId, workEffortId, custRequestId, custRequestItemSeqId, quantity, selectedAmount, quoteUnitPrice, reservStart, reservLength, reservPersons, configId, estimatedDeliveryDate, comments, isPromo, leadTimeDays
	}
