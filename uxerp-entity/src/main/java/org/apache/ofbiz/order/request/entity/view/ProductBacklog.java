package org.apache.ofbiz.order.request.entity.view;
...
public class ProductBacklog implements Serializable {
	...
	public static final long serialVersionUID = 7053991237829988352L;
	public static final String NAME = "ProductBacklog";
	/**
	 * Cust Request Id
	 */
	@Getter
	...
	public ProductBacklog(GenericValue value) {
	...
	public static ProductBacklog fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProductBacklog(value);
	}

	public static List<ProductBacklog> fromValues(List<GenericValue> values) {
		List<ProductBacklog> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProductBacklog(value));
		}
		return entities;
	}
}