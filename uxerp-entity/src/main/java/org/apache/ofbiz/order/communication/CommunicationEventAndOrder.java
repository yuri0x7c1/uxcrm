...
/**
 * Communication Event And Order
 */
public class CommunicationEventAndOrder implements Serializable {

	public static final long serialVersionUID = 1099689268316546048L;
	public static final String NAME = "CommunicationEventAndOrder";
	/**
	 * Order Id
	 */
	@Getter
	...
	public CommunicationEventAndOrder(GenericValue value) {
	...
	public static CommunicationEventAndOrder fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new CommunicationEventAndOrder(value);
	}

	public static List<CommunicationEventAndOrder> fromValues(
			List<GenericValue> values) {
		List<CommunicationEventAndOrder> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new CommunicationEventAndOrder(value));
		}
		return entities;
	}
}