...
public class ShoppingList implements Serializable {
	...
	public static final long serialVersionUID = 4513011910200279040L;
	...
	public enum Fields {
		shoppingListId, shoppingListTypeId, parentShoppingListId, productStoreId, visitorId, partyId, listName, description, isPublic, isActive, currencyUom, shipmentMethodTypeId, carrierPartyId, carrierRoleTypeId, contactMechId, paymentMethodId, recurrenceInfoId, lastOrderedDate, lastAdminModified, productPromoCodeId
	}
