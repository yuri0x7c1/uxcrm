...
public class InvItemAndOrdItem implements Serializable {
	...
	public static final long serialVersionUID = 7062021525751324672L;
	...
	public enum Fields {
		invoiceId, invoiceItemSeqId, invoiceItemTypeId, overrideGlAccountId, overrideOrgPartyId, inventoryItemId, productId, productFeatureId, parentInvoiceId, parentInvoiceItemSeqId, uomId, taxableFlag, quantity, amount, description, taxAuthPartyId, taxAuthGeoId, taxAuthorityRateSeqId, salesOpportunityId, orderId, orderItemSeqId
	}
