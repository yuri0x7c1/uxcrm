...
public class PaymentGatewayPayflowPro implements Serializable {
	...
	public static final long serialVersionUID = 92204916701277184L;
	...
	public enum Fields {
		paymentGatewayConfigId, certsPath, hostAddress, hostPort, timeout, proxyAddress, proxyPort, proxyLogon, proxyPassword, vendor, userId, pwd, partner, checkAvs, checkCvv2, preAuth, enableTransmit, logFileName, loggingLevel, maxLogFileSize, stackTraceOn, redirectUrl, returnUrl, cancelReturnUrl
	}
