...
public class PaymentGatewayiDEAL implements Serializable {
	...
	public static final long serialVersionUID = 9184715580784663552L;
	...
	public enum Fields {
		paymentGatewayConfigId, merchantId, merchantSubId, merchantReturnURL, acquirerURL, acquirerTimeout, privateCert, acquirerKeyStoreFilename, acquirerKeyStorePassword, merchantKeyStoreFilename, merchantKeyStorePassword, expirationPeriod
	}
