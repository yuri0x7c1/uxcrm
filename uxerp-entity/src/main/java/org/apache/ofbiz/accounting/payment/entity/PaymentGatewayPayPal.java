...
public class PaymentGatewayPayPal implements Serializable {
	...
	public static final long serialVersionUID = 546914291179819008L;
	...
	public enum Fields {
		paymentGatewayConfigId, businessEmail, apiUserName, apiPassword, apiSignature, apiEnvironment, notifyUrl, returnUrl, cancelReturnUrl, imageUrl, confirmTemplate, redirectUrl, confirmUrl, shippingCallbackUrl, requireConfirmedShipping
	}
