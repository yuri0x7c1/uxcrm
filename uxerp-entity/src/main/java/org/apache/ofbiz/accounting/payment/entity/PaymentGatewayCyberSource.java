...
public class PaymentGatewayCyberSource implements Serializable {
	...
	public static final long serialVersionUID = 3266824901682148352L;
	...
	public enum Fields {
		paymentGatewayConfigId, merchantId, apiVersion, production, keysDir, keysFile, logEnabled, logDir, logFile, logSize, merchantDescr, merchantContact, autoBill, enableDav, fraudScore, ignoreAvs, disableBillAvs, avsDeclineCodes
	}
