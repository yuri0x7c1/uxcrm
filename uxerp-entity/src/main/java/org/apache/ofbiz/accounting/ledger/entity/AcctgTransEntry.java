...
public class AcctgTransEntry implements Serializable {
	...
	public static final long serialVersionUID = 1442561684559706112L;
	...
	public enum Fields {
		acctgTransId, acctgTransEntrySeqId, acctgTransEntryTypeId, description, voucherRef, partyId, roleTypeId, theirPartyId, productId, theirProductId, inventoryItemId, glAccountTypeId, glAccountId, organizationPartyId, amount, currencyUomId, origAmount, origCurrencyUomId, debitCreditFlag, dueDate, groupId, taxId, reconcileStatusId, settlementTermId, isSummary
	}
