...
public class InvoiceItemAssocType implements Serializable {
	...
	public static final long serialVersionUID = 3757064198065512448L;
	...
	public enum Fields {
		invoiceItemAssocTypeId, parentTypeId, hasTable, description, lastUpdatedStamp, lastUpdatedTxStamp, createdStamp, createdTxStamp
	}
