...
public class PaymentApplication implements Serializable {
	...
	public static final long serialVersionUID = 7621683143707827200L;
	...
	public enum Fields {
		paymentApplicationId, paymentId, invoiceId, invoiceItemSeqId, billingAccountId, overrideGlAccountId, toPaymentId, taxAuthGeoId, amountApplied
	}
