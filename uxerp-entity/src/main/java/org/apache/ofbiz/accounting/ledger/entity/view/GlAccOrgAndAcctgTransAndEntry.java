...
public class GlAccOrgAndAcctgTransAndEntry implements Serializable {
	...
	public static final long serialVersionUID = 6432035292448803840L;
	...
	public enum Fields {
		glAccountId, debitCreditFlag, isPosted, transactionDate, acctgTransId, organizationPartyId, amount, fromDate, thruDate
	}
