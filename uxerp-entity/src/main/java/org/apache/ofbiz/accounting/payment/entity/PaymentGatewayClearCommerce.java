...
public class PaymentGatewayClearCommerce implements Serializable {
	...
	public static final long serialVersionUID = 3596392815235510272L;
	...
	public enum Fields {
		paymentGatewayConfigId, sourceId, groupId, clientId, username, pwd, userAlias, effectiveAlias, processMode, serverURL, enableCVM
	}
