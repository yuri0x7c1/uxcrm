...
public class AcctgTransAndEntries implements Serializable {
	...
	public static final long serialVersionUID = 8256918272235484160L;
	...
	public enum Fields {
		isPosted, glFiscalTypeId, acctgTransTypeId, transactionDate, postedDate, description, glJournalId, invoiceId, paymentId, shipmentId, receiptId, inventoryItemId, workEffortId, fixedAssetId, physicalInventoryId, acctgTransId, acctgTransEntrySeqId, glAccountId, productId, debitCreditFlag, amount, currencyUomId, origAmount, origCurrencyUomId, organizationPartyId, glAccountTypeId, accountCode, accountName, glAccountClassId, partyId, reconcileStatusId, acctgTransEntryTypeId
	}
