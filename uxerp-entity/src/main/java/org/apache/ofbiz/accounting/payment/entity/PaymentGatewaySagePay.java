...
public class PaymentGatewaySagePay implements Serializable {
	...
	public static final long serialVersionUID = 3107149116904360960L;
	...
	public enum Fields {
		paymentGatewayConfigId, vendor, productionHost, testingHost, sagePayMode, protocolVersion, authenticationTransType, authenticationUrl, authoriseTransType, authoriseUrl, releaseTransType, releaseUrl, voidUrl, refundUrl
	}
