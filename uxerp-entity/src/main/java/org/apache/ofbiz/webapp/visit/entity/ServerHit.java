...
public class ServerHit implements Serializable {
	...
	public static final long serialVersionUID = 6228696445608288256L;
	...
	public enum Fields {
		visitId, contentId, hitStartDateTime, hitTypeId, numOfBytes, runningTimeMillis, userLoginId, statusId, requestUrl, referrerUrl, serverIpAddress, serverHostName
	}
