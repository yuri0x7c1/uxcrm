...
public class ShipmentPackage implements Serializable {
	...
	public static final long serialVersionUID = 6075095300521422848L;
	...
	public enum Fields {
		shipmentId, shipmentPackageSeqId, shipmentBoxTypeId, dateCreated, boxLength, boxHeight, boxWidth, dimensionUomId, weight, weightUomId, insuredValue
	}
