...
public class PartyDetailAndWorkEffortAssign implements Serializable {
	...
	public static final long serialVersionUID = 112968257283346432L;
	...
	public enum Fields {
		partyId, partyTypeId, statusId, workEffortTypeId, workEffortId, fromDate, thruDate, roleTypeId, firstName, middleName, lastName, groupName
	}
