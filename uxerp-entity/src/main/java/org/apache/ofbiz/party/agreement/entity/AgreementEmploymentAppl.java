...
public class AgreementEmploymentAppl implements Serializable {
	...
	public static final long serialVersionUID = 9004330092887221248L;
	...
	public enum Fields {
		agreementId, agreementItemSeqId, partyIdFrom, partyIdTo, roleTypeIdFrom, roleTypeIdTo, fromDate, agreementDate, thruDate
	}
