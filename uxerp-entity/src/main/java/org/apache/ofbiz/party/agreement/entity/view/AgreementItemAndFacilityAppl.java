...
public class AgreementItemAndFacilityAppl implements Serializable {
	...
	public static final long serialVersionUID = 8703247431571050496L;
	...
	public enum Fields {
		agreementId, agreementItemSeqId, agreementItemTypeId, currencyUomId, agreementText, agreementImage, facilityId, productId, partyIdFrom, partyIdTo, roleTypeIdFrom, roleTypeIdTo, agreementTypeId, agreementDate, fromDate, thruDate, description, textData
	}
