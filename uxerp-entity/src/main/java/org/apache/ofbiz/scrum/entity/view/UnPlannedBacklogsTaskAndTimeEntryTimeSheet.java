...
/**
 * Un Planned Backlogs Task And Time Entry Time Sheet
 */
public class UnPlannedBacklogsTaskAndTimeEntryTimeSheet implements Serializable {

	public static final long serialVersionUID = 1780717733276076032L;
	public static final String NAME = "UnPlannedBacklogsTaskAndTimeEntryTimeSheet";
	/**
	 * Time Entry Id
	 */
	@Getter
	...
	public UnPlannedBacklogsTaskAndTimeEntryTimeSheet(GenericValue value) {
	...
	public static UnPlannedBacklogsTaskAndTimeEntryTimeSheet fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new UnPlannedBacklogsTaskAndTimeEntryTimeSheet(value);
	}

	public static List<UnPlannedBacklogsTaskAndTimeEntryTimeSheet> fromValues(
			List<GenericValue> values) {
		List<UnPlannedBacklogsTaskAndTimeEntryTimeSheet> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new UnPlannedBacklogsTaskAndTimeEntryTimeSheet(value));
		}
		return entities;
	}
}