...
/**
 * Project Sprint Backlog Task And Party
 */
public class ProjectSprintBacklogTaskAndParty implements Serializable {

	public static final long serialVersionUID = 9023971715431280640L;
	public static final String NAME = "ProjectSprintBacklogTaskAndParty";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static ProjectSprintBacklogTaskAndParty fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectSprintBacklogTaskAndParty(value);
	}

	public static List<ProjectSprintBacklogTaskAndParty> fromValues(
			List<GenericValue> values) {
		List<ProjectSprintBacklogTaskAndParty> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectSprintBacklogTaskAndParty(value));
		}
		return entities;
	}
}