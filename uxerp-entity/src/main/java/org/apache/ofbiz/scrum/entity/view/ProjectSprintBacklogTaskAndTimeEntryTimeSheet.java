...
/**
 * Project Sprint Backlog Task And Time Entry Time Sheet
 */
public class ProjectSprintBacklogTaskAndTimeEntryTimeSheet
		implements
			Serializable {

	public static final long serialVersionUID = 4310766853817939968L;
	public static final String NAME = "ProjectSprintBacklogTaskAndTimeEntryTimeSheet";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static ProjectSprintBacklogTaskAndTimeEntryTimeSheet fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectSprintBacklogTaskAndTimeEntryTimeSheet(value);
	}

	public static List<ProjectSprintBacklogTaskAndTimeEntryTimeSheet> fromValues(
			List<GenericValue> values) {
		List<ProjectSprintBacklogTaskAndTimeEntryTimeSheet> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectSprintBacklogTaskAndTimeEntryTimeSheet(
					value));
		}
		return entities;
	}
