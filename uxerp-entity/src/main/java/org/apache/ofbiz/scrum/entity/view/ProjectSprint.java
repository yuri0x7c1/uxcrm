...
public class ProjectSprint implements Serializable {
	...
	public static final long serialVersionUID = 7543881384468130816L;
	public static final String NAME = "ProjectSprint";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static ProjectSprint fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectSprint(value);
	}

	public static List<ProjectSprint> fromValues(List<GenericValue> values) {
		List<ProjectSprint> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectSprint(value));
		}
		return entities;
	}
}