...
/**
 * Un Planned Backlogs And Tasks
 */
public class UnPlannedBacklogsAndTasks implements Serializable {

	public static final long serialVersionUID = 144339215353513984L;
	public static final String NAME = "UnPlannedBacklogsAndTasks";
	/**
	 * Cust Request Id
	 */
	@Getter
	...
	public static UnPlannedBacklogsAndTasks fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new UnPlannedBacklogsAndTasks(value);
	}

	public static List<UnPlannedBacklogsAndTasks> fromValues(
			List<GenericValue> values) {
		List<UnPlannedBacklogsAndTasks> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new UnPlannedBacklogsAndTasks(value));
		}
		return entities;
	}
}