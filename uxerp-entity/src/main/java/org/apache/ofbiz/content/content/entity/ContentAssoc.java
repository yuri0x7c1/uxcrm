...
public class ContentAssoc implements Serializable {
	...
	public static final long serialVersionUID = 7040645475970382848L;
	...
	public enum Fields {
		contentId, contentIdTo, contentAssocTypeId, fromDate, thruDate, contentAssocPredicateId, dataSourceId, sequenceNum, mapKey, upperCoordinate, leftCoordinate, createdDate, createdByUserLogin, lastModifiedDate, lastModifiedByUserLogin
	}
