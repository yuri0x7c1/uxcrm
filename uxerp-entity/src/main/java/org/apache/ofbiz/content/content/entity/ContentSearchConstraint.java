...
public class ContentSearchConstraint implements Serializable {
	...
	public static final long serialVersionUID = 2315232921062910976L;
	...
	public enum Fields {
		contentSearchResultId, constraintSeqId, constraintName, infoString, includeSubCategories, isAnd, anyPrefix, anySuffix, removeStems, lowValue, highValue
	}
