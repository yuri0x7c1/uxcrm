...
public class PartyContentDetail implements Serializable {
	...
	public static final long serialVersionUID = 2134353312354791424L;
	...
	public enum Fields {
		partyId, contentId, partyContentTypeId, fromDate, thruDate, contentTypeId, ownerContentId, decoratorContentId, instanceOfContentId, dataResourceId, templateDataResourceId, dataSourceId, statusId, privilegeEnumId, serviceName, customMethodId, contentName, description, localeString, mimeTypeId, characterSetId, childLeafCount, childBranchCount, createdDate, createdByUserLogin, lastModifiedDate, lastModifiedByUserLogin
	}
