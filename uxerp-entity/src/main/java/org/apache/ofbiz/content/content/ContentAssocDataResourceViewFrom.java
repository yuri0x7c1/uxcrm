 ...
 */
public class ContentAssocDataResourceViewFrom implements Serializable {

	public static final long serialVersionUID = 3367523814985290752L;
	public static final String NAME = "ContentAssocDataResourceViewFrom";
	/**
	 * Content Id Start
	 */
	@Getter
	...
	public enum Fields {
		contentIdStart, ownerContentId, contentId, contentTypeId, description, mimeTypeId, childLeafCount, privilegeEnumId, dataSourceId, lastModifiedByUserLogin, dataResourceId, createdByUserLogin, templateDataResourceId, lastModifiedDate, instanceOfContentId, serviceName, customMethodId, characterSetId, contentName, createdDate, statusId, localeString, decoratorContentId, childBranchCount, caSequenceNum, caLastModifiedDate, caContentIdTo, caUpperCoordinate, caLeftCoordinate, caContentId, caMapKey, caThruDate, caFromDate, caContentAssocPredicateId, caDataSourceId, caLastModifiedByUserLogin, caCreatedDate, caContentAssocTypeId, caCreatedByUserLogin, drDataResourceName, drSurveyId, drDataTemplateTypeId, drLastModifiedDate, drMimeTypeId, drDataCategoryId, drSurveyResponseId, drCharacterSetId, drDataSourceId, drLastModifiedByUserLogin, drCreatedDate, drStatusId, drLocaleString, drRelatedDetailId, drDataResourceId, drIsPublic, drObjectInfo, drDataResourceTypeId, drCreatedByUserLogin
	}

	public ContentAssocDataResourceViewFrom(GenericValue value) {
	...
	public static ContentAssocDataResourceViewFrom fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ContentAssocDataResourceViewFrom(value);
	}

	public static List<ContentAssocDataResourceViewFrom> fromValues(
			List<GenericValue> values) {
		List<ContentAssocDataResourceViewFrom> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ContentAssocDataResourceViewFrom(value));
		}
		return entities;
	}
}