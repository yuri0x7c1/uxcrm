...
public class WorkEffortAssocToView implements Serializable {
	...
	public WorkEffortAssocToView(GenericValue value) {
	...
	public static WorkEffortAssocToView fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new WorkEffortAssocToView(value);
	}

	public static List<WorkEffortAssocToView> fromValues(
			List<GenericValue> values) {
		List<WorkEffortAssocToView> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new WorkEffortAssocToView(value));
		}
		return entities;
	}
}