...
public class WorkEffortPartyAssignment implements Serializable {
	...
	public static final long serialVersionUID = 7817916291713991680L;
	...
	public enum Fields {
		workEffortId, partyId, roleTypeId, fromDate, thruDate, assignedByUserLoginId, statusId, statusDateTime, expectationEnumId, delegateReasonEnumId, facilityId, comments, mustRsvp, availabilityStatusId
	}
