package org.apache.ofbiz._return.communication;
...
/**
 * Communication Event And Return
 */
public class CommunicationEventAndReturn implements Serializable {

	public static final long serialVersionUID = 541860719633639424L;
	public static final String NAME = "CommunicationEventAndReturn";
	/**
	 * Return Id
	 */
	@Getter
	...
	public static CommunicationEventAndReturn fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new CommunicationEventAndReturn(value);
	}

	public static List<CommunicationEventAndReturn> fromValues(
			List<GenericValue> values) {
		List<CommunicationEventAndReturn> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new CommunicationEventAndReturn(value));
		}
		return entities;
	}
}