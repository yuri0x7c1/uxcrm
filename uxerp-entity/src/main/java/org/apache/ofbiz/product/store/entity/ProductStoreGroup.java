...
public class ProductStoreGroup implements Serializable {
	...
	public static final long serialVersionUID = 8581033668059987968L;
	...
	public enum Fields {
		productStoreGroupId, productStoreGroupTypeId, primaryParentGroupId, productStoreGroupName, description
	}
