...
public class ProductStorePaymentSetting implements Serializable {
	...
	public static final long serialVersionUID = 3358400327030837248L;
	...
	public enum Fields {
		productStoreId, paymentMethodTypeId, paymentServiceTypeEnumId, paymentService, paymentCustomMethodId, paymentGatewayConfigId, paymentPropertiesPath, applyToAllProducts
	}
