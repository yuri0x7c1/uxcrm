...
public class CostComponent implements Serializable {
	...
	public static final long serialVersionUID = 4759557943330396160L;
	...
	public enum Fields {
		costComponentId, costComponentTypeId, productId, productFeatureId, partyId, geoId, workEffortId, fixedAssetId, costComponentCalcId, fromDate, thruDate, cost, costUomId
	}
