...
public class ProductCategoryLink implements Serializable {
	...
	public static final long serialVersionUID = 1660455125392478208L;
	...
	public enum Fields {
		productCategoryId, linkSeqId, fromDate, thruDate, comments, sequenceNum, titleText, detailText, imageUrl, imageTwoUrl, linkTypeEnumId, linkInfo, detailSubScreen
	}
