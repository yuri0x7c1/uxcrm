...
public class ProductFeatureAppl implements Serializable {
	...
	public static final long serialVersionUID = 5533066048088583168L;
	...
	public enum Fields {
		productId, productFeatureId, productFeatureApplTypeId, fromDate, thruDate, sequenceNum, amount, recurringAmount
	}
