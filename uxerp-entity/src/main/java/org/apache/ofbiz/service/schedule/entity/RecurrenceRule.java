...
public class RecurrenceRule implements Serializable {
	...
	public static final long serialVersionUID = 6093041339853666304L;
	...
	public enum Fields {
		recurrenceRuleId, frequency, untilDateTime, countNumber, intervalNumber, bySecondList, byMinuteList, byHourList, byDayList, byMonthDayList, byYearDayList, byWeekNoList, byMonthList, bySetPosList, weekStart, xName
	}
