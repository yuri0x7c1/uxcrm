...
public class TrackingCodeOrder implements Serializable {
	...
	public static final long serialVersionUID = 4134702182999157760L;
	...
	public enum Fields {
		orderId, trackingCodeTypeId, trackingCodeId, isBillable, siteId, hasExported, affiliateReferredTimeStamp
	}
