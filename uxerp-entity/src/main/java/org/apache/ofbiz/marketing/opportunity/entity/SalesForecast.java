...
public class SalesForecast implements Serializable {
	...
	public static final long serialVersionUID = 1390290600138852352L;
	...
	public enum Fields {
		salesForecastId, parentSalesForecastId, organizationPartyId, internalPartyId, customTimePeriodId, currencyUomId, quotaAmount, forecastAmount, bestCaseAmount, closedAmount, percentOfQuotaForecast, percentOfQuotaClosed, pipelineAmount, createdByUserLoginId, modifiedByUserLoginId
	}
