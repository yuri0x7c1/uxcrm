...
/**
 * Project Phase Task And Time Entry Time Sheet
 */
public class ProjectPhaseTaskAndTimeEntryTimeSheet implements Serializable {

	public static final long serialVersionUID = 7378503137479572480L;
	public static final String NAME = "ProjectPhaseTaskAndTimeEntryTimeSheet";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public static ProjectPhaseTaskAndTimeEntryTimeSheet fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectPhaseTaskAndTimeEntryTimeSheet(value);
	}

	public static List<ProjectPhaseTaskAndTimeEntryTimeSheet> fromValues(
			List<GenericValue> values) {
		List<ProjectPhaseTaskAndTimeEntryTimeSheet> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectPhaseTaskAndTimeEntryTimeSheet(value));
		}
		return entities;
	}
}