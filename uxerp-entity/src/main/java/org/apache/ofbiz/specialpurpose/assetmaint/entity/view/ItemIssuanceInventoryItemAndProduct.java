...
/**
 * Item Issuance Inventory Item And Product
 */
public class ItemIssuanceInventoryItemAndProduct implements Serializable {

	public static final long serialVersionUID = 3715348836596443136L;
	public static final String NAME = "ItemIssuanceInventoryItemAndProduct";
	/**
	 * Item Issuance Id
	 */
	@Getter
	...
	public ItemIssuanceInventoryItemAndProduct(GenericValue value) {
	...
	public static ItemIssuanceInventoryItemAndProduct fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ItemIssuanceInventoryItemAndProduct(value);
	}

	public static List<ItemIssuanceInventoryItemAndProduct> fromValues(
			List<GenericValue> values) {
		List<ItemIssuanceInventoryItemAndProduct> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ItemIssuanceInventoryItemAndProduct(value));
		}
		return entities;
	}
}