...
/**
 * Fixed Asset Maint Work Effort And Time Entry
 */
public class FixedAssetMaintWorkEffortAndTimeEntry implements Serializable {

	public static final long serialVersionUID = 7930822219312230400L;
	public static final String NAME = "FixedAssetMaintWorkEffortAndTimeEntry";
	/**
	 * Fixed Asset Id
	 */
	@Getter
	...
	public static FixedAssetMaintWorkEffortAndTimeEntry fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new FixedAssetMaintWorkEffortAndTimeEntry(value);
	}

	public static List<FixedAssetMaintWorkEffortAndTimeEntry> fromValues(
			List<GenericValue> values) {
		List<FixedAssetMaintWorkEffortAndTimeEntry> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new FixedAssetMaintWorkEffortAndTimeEntry(value));
		}
		return entities;
	}
}