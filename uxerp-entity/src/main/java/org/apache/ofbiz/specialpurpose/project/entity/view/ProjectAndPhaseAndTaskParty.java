...
/**
 * Project And Phase And Task Party
 */
public class ProjectAndPhaseAndTaskParty implements Serializable {

	public static final long serialVersionUID = 7660104164484552704L;
	public static final String NAME = "ProjectAndPhaseAndTaskParty";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public ProjectAndPhaseAndTaskParty(GenericValue value) {
	...
	public static ProjectAndPhaseAndTaskParty fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectAndPhaseAndTaskParty(value);
	}

	public static List<ProjectAndPhaseAndTaskParty> fromValues(
			List<GenericValue> values) {
		List<ProjectAndPhaseAndTaskParty> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectAndPhaseAndTaskParty(value));
		}
		return entities;
	}
}