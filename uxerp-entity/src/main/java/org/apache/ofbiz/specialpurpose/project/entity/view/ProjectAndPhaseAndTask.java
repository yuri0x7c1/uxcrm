...
/**
 * Project And Phase And Task
 */
public class ProjectAndPhaseAndTask implements Serializable {

	public static final long serialVersionUID = 755101054921439232L;
	public static final String NAME = "ProjectAndPhaseAndTask";
	/**
	 * Work Effort Id
	 */
	@Getter
	...
	public ProjectAndPhaseAndTask(GenericValue value) {
	...
	public static ProjectAndPhaseAndTask fromValue(
			org.apache.ofbiz.entity.GenericValue value) {
		return new ProjectAndPhaseAndTask(value);
	}

	public static List<ProjectAndPhaseAndTask> fromValues(
			List<GenericValue> values) {
		List<ProjectAndPhaseAndTask> entities = new ArrayList<>();
		for (GenericValue value : values) {
			entities.add(new ProjectAndPhaseAndTask(value));
		}
		return entities;
	}
}