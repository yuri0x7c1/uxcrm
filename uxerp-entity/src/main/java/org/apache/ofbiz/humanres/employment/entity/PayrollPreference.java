...
public class PayrollPreference implements Serializable {
	...
	public static final long serialVersionUID = 6097271996101230592L;
	...
	public enum Fields {
		partyId, roleTypeId, payrollPreferenceSeqId, deductionTypeId, paymentMethodTypeId, periodTypeId, fromDate, thruDate, percentage, flatAmount, routingNumber, accountNumber, bankName
	}
