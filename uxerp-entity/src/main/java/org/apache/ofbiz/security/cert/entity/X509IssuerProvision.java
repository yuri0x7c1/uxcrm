package org.apache.ofbiz.security.cert.entity;
...
public class X509IssuerProvision implements Serializable {
	...
	public static final long serialVersionUID = 5029122205380581376L;
	...
	public enum Fields {
		certProvisionId, commonName, organizationalUnit, organizationName, cityLocality, stateProvince, country, serialNumber
	}
